report 52178531 "PRN Memo Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './MEMO/Reports/SSR/FINMemoReport1.rdl';
    ...
    dataset
    {
        dataitem(MemoHeader; "FIN-Memo Header")
        {
            ...
            column(GlobalDimension1Code_MemoHeader; "Global Dimension 1 Code")
            {
            }
            column(GlobalDimension2Code_MemoHeader; "Global Dimension 2 Code")
            {
            }
            column(ShortcutDimension3Code_MemoHeader; "Shortcut Dimension 3 Code")
            {
            }
