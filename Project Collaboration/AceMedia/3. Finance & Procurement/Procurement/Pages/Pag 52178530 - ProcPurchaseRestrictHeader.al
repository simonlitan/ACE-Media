page 52178639 "Proc-Purchase Restrict Header"
{
    ...
    layout
    {
        area(content)
        {
            ...
            group("Restricted Header Information")
            {
                Editable = Editability;
                //ShowCaption = false;
        ...
        area(processing)
        {
            group("Vendors")
            {
                ...
                action("Selected Vendor(s)")
                {
                    ...
                    begin
                        Vends.RESET;
                        Vends.SETRANGE(Vends."Document Type", Vends."Document Type"::"Restricted Tendering");
    ...
    begin
        ...
        Rec."Procurement methods" := Rec."Procurement methods"::"Restricted Tendering";
        Initializevariables();
        if rec."No." = '' then
            Purchasespaybles.reset();
        Purchasespaybles.SetRange("Doc Type", Purchasespaybles."Doc Type"::"Restricted Tendering");
