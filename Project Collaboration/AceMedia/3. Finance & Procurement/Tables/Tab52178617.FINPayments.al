table 52178617 "FIN-Payments"
{
    ...
    fields
    {
        ...
        field(40; "Bank Type"; Option)
        {
            OptionMembers = Normal,"Petty Cash";
        }
        field(41; "PV Type"; Option)
        {
            OptionMembers = Normal,Other;
        }
        field(42; "Apply to"; Code[20])
        {
        ...
        field(43; "Apply to ID"; Code[20])
        {
        }
        field(44; "No of Units"; Decimal)
        {
        }
        field(45; "Surrender Date"; Date)
        {
        }
        field(46; Surrendered; Boolean)
        {
            InitValue = false;
        }
        field(47; "Surrender Doc. No"; Code[20])
        {
        }

        field(48; "Vote Book"; Code[10])
        {
        ...
        field(49; "Total Allocation"; Decimal)
        {
        }
        field(50; "Total Expenditure"; Decimal)
        {
        }
        field(51; "Total Commitments"; Decimal)
        {
        }
        field(52; Balance; Decimal)
        {
        }
        field(53; "Balance Less this Entry"; Decimal)
        {
        }
        field(54; "Applicant Designation"; Text[100])
        {
        }
        field(55; "Petty Cash"; Boolean)
        {
        }
        field(56; "Retention Fee Code"; Code[10])
        {
            TableRelation = "FIN-Tariff Codes";
        }
        field(57; "Retention Fee Amount"; Decimal)
        {
        }
        field(100; "Admin Remarks"; Text[100])
        {
        }
        field(58; "HOD Remarks"; Text[30])
        {
        ...
        field(59; "Surrender Remarks"; Text[30])
        {
        }
        field(60; "IW No"; Code[10])
        {
        ...
        field(114; "From Date"; Date)
        {
        }
        field(115; "To date"; Date)
        {
        }
        field(116; "While In"; Code[20])
        {
        }
    }
    ...
    var
        ...
        BudgetRec: Record "G/L Budget Entry";
