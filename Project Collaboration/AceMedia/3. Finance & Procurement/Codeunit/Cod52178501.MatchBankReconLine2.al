/// <summary>
/// Codeunit Match Bank Recon Line 2 (ID 52178501).
/// </summary>
codeunit 52178524 "Match Bank Recon Line 2"
{
    ...
    var
        MatchingRelationship: Option "One-To-Many","Many-To-One";
    ...
    begin
        ...
        FilterDate := BankAccReconciliation.MatchCandidateFilterDate2();
    ...
    procedure MatchMany2One(var SelectedBankAccReconciliationLine: Record "Bank Acc. Reconciliation Line"; var SelectedBankAccountLedgerEntry: Record "Bank Account Ledger Entry"; MatchingRelationship: Option "One-To-Many","Many-To-One")
    var
        BankAccReconciliationLine: Record "Bank Acc. Reconciliation Line";
        BankAccountLedgerEntry: Record "Bank Account Ledger Entry";
        BankAccEntrySetReconNo: Codeunit "Bank Acc. Entry Set Recon.-No.";
        BankAccEntrySetReconNo2: Codeunit "Bank Acc Entry Rec No";
    begin
        ...
        //      BankAccountLedgerEntry.GET(SelectedBankAccountLedgerEntry."Entry No.");
        //      //BankAccEntrySetReconNo.RemoveApplication(BankAccountLedgerEntry);
        //      IF MatchingRelationship = MatchingRelationship::"Many-To-One" THEN
        //       BankAccEntrySetReconNo.ApplyEntries(BankAccReconciliationLine,BankAccountLedgerEntry,Relation::"Many-to-One")
        //      ELSE
        //       BankAccEntrySetReconNo.ApplyEntries2(BankAccReconciliationLine,BankAccountLedgerEntry,Relation::"Many-to-One");
        //    UNTIL SelectedBankAccountLedgerEntry.NEXT = 0;
        //  END;
        // END;
        ...
        IF SelectedBankAccReconciliationLine.FINDFIRST THEN BEGIN
            ...
            IF SelectedBankAccountLedgerEntry.FINDSET THEN BEGIN
                REPEAT
                    BankAccountLedgerEntry.GET(SelectedBankAccountLedgerEntry."Entry No.");
                    //BankAccEntrySetReconNo.RemoveApplication(BankAccountLedgerEntry);
                    //IF MatchingRelationship = MatchingRelationship::"One-To-Many" THEN
                    //    BankAccEntrySetReconNo.ApplyEntries(BankAccReconciliationLine, BankAccountLedgerEntry, Relation::"One-to-Many")
                    // ELSE
                    Message('ok');
                    BankAccEntrySetReconNo2.ApplyEntries2(BankAccReconciliationLine, BankAccountLedgerEntry, Relation::"One-to-Many");
                UNTIL SelectedBankAccountLedgerEntry.NEXT = 0;
            END;
        END;
    end;
    ...
    procedure MatchManually3(var SelectedBankAccReconciliationLine: Record "Bank Acc. Reconciliation Line"; var SelectedBankAccountLedgerEntry: Record "Bank Account Ledger Entry")
    var
        BankAccReconciliationLine: Record "Bank Acc. Reconciliation Line";
        BankAccountLedgerEntry: Record "Bank Account Ledger Entry";
        BankAccEntrySetReconNo: Codeunit "Bank Acc Entry Rec No";
        ...
        IF SelectedBankAccReconciliationLine.FINDFIRST THEN BEGIN
            ...
            IF SelectedBankAccountLedgerEntry.FINDSET THEN BEGIN
                REPEAT
                    ...
                    // ELSE
                    //  Message('okay');
                    BankAccEntrySetReconNo.ApplyEntries2(BankAccReconciliationLine, BankAccountLedgerEntry, Relation::"One-to-Many");
                UNTIL SelectedBankAccountLedgerEntry.NEXT = 0;
            END;
        END;
    end;
