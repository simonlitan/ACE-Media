page 52178559 "Tender Submission Qualified"
{
    Caption = 'Qualified Submissions';
    CardPageID = "Tender Tier Submission Header";
    Editable = false;
    PageType = ListPart;
    SourceTable = "Tender Submission Header";
    SourceTableView = where("Bid Status" = filter("Prelim qualif" | "Tech Qualf" | "Demo Qualif" | "Fin Qualif"));
