table 52178566 "FIN-Cash Office User Template"
{
    ...
    fields
    {
        ...
        field(27; "Direct Cash Sale Bank"; Code[20])
        {
            TableRelation = "Bank Account"."No." WHERE("Bank Type" = FILTER(Cash));
        }
        field(28; "Direct Sales Inv. Nos."; Code[20])
        {
            TableRelation = "No. Series".Code;
        }
        field(29; "Cash Receipt No. Series"; Code[20])
        {
            TableRelation = "No. Series".Code;
        }
        field(30; "Default Direct Sale Customer"; Code[20])
        {
            TableRelation = Customer."No.";
        }
        field(31; "Direct Sales External Doc. Nos"; Code[20])
        {
            TableRelation = "No. Series".Code;
        }
        field(32; "Default Direct Sales Location"; Code[20])
        {
            //TableRelation = Location.Code WHERE ("Cafeteria Location"=FILTER(Yes));
        }
        field(33; "Direct Sales Item Category"; Code[20])
        {
            TableRelation = "Item Category";
        }
        field(34; "Direct Cash Sale Deposit Nos."; Code[20])
        {
            TableRelation = "No. Series".Code;
        }
        ...
        field(38; "Direct  Cash Sale Paybill"; Code[20])
        {
            TableRelation = "Bank Account"."No." WHERE("Bank Type" = FILTER(Cash));
        }
    }
