page 52178685 "FIN-Posted Travel Advs. Acc."
{
                ...
                begin
                    ...
                    IF ImprestDetails.FIND('-') THEN BEGIN
                        REPEAT
                            ...
                            // GenJnlLine.Description := 'Imprest: ' + Rec."Account No." + ':' + Rec.Remarks;
                            GenJnlLine.Narration := 'Imprest: ' + Rec."Account No." + ':' + Rec.Remarks;
