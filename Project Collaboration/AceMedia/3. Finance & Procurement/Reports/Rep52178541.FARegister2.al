report 52178541 "FA Register 2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSR/FixedAssetBookValue01.rdl';
    ApplicationArea = FixedAssets;
    Caption = 'Fixed Asset Book Value';
    ...
    dataset
    {
        dataitem("Fixed Asset"; "Fixed Asset")
        {
            ...
            column(Companyifopic; Companyifo.Picture)
            {

            }
            column(Companyifoaddress; Companyifo.Address)
            {

            }
            column(Companyifofax; Companyifo."Fax No.")
            {

            }
            column(Companyifophone; Companyifo."Phone No.")
            {

            }
            column(Companyifoemail; Companyifo."E-Mail")
            {

            }
            column(Companyifowebpage; Companyifo."Home Page")
            {
            ...
            column(GoogleCoordinates_FixedAsset; "Google Coordinates")
            {
            }
            column(TitleNO_FixedAsset; "Title NO.")
            {
            }
    ...
    var
        ...
        Companyifo: record "Company Information";
