table 52179182 "Staff Attendance Ledger"
{
    ...
    fields
    {
        ...
        field(2; "Staff No."; Code[10])
        {
            ...
            begin
                ...
                if Category = '' then Category := 'casual';
            end;
        }
        ...
        field(12; "Time Out"; Time)
        {
            ...
            begin
                if "Time In" <> 0T then begin
                    "Hours Worked" := ((Time - "Time In") / 3600000);
                end;
            end;
        }
    ...
    begin
        ...
        if "Visit No." = '' then begin
            ...
            "Visit No." := NoSeriesMgt.GetNextNo(GenLedgerSet."Staff Register Nos", Today, true); */
        end;
    ...
    var
        ...
        StaffLedger: Record "Staff Attendance Ledger";
