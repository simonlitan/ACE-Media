table 52178577 "FIN-Staff Advance Surr. Header"
{
    ...
    fields
    {
        ...
        field(24; "Net Amount"; Decimal)
        {
        }
        field(25; "Paying Bank Account"; Code[20])
        {
        }
        field(26; Payee; Text[100])
        {
        }
        ...
        field(29; "Bank Account No"; Code[20])
        {
        }
        field(30; "Cashier Bank Account"; Code[20])
        {
        }
        ...
        field(32; Grouping; Code[20])
        {
            TableRelation = "Customer Posting Group".Code;
        }
        field(33; "Payment Type"; Option)
        {
        ...
        field(35; "PV Type"; Option)
        {
            OptionMembers = Normal,Other;
        }
        field(36; "Apply to ID"; Code[20])
        {
        }
        field(37; "Imprest Issue Date"; Date)
        {
        }
        field(38; Surrendered; Boolean)
        {
        }
        field(39; "Imprest Issue Doc. No"; Code[20])
        {
            ...
            begin
                ...
                PayLine.RESET;
                PayLine.SETRANGE(PayLine."Document No.", "Imprest Issue Doc. No");
        ...
        field(40; "Vote Book"; Code[10])
        {
            TableRelation = "G/L Account";
        }
        field(41; "Total Allocation"; Decimal)
        {
        }
        field(42; "Total Expenditure"; Decimal)
        {
        }
        field(43; "Total Commitments"; Decimal)
        {
        }
        field(44; Balance; Decimal)
        {
        }
        field(45; "Balance Less this Entry"; Decimal)
        {
        }
        field(46; "Petty Cash"; Boolean)
        {
        }
        ...
        field(48; "Function Name"; Text[50])
        {
        }
        field(49; "Budget Center Name"; Text[50])
        {
        }
        ...
        field(51; "Issue Voucher Type"; Option)
        {
        ...
        field(54; Dim3; Text[250])
        {
        }
        field(55; Dim4; Text[250])
        {
        }
        ...
        field(58; "Responsibility Center"; Code[10])
        {
        ...
        field(63; "Total Amount Advanced"; Decimal)
        {
        }
        field(64; "Allow Overexpenditure"; Boolean)
        {
            Editable = false;
        }
        field(65; "Open for Overexpenditure by"; Code[20])
        {
            Editable = false;
        }
        field(66; "Date opened for OvExpenditure"; Date)
        {
            Editable = false;
        }
        field(67; "Cash Receipt Amount"; Decimal)
        {
            FieldClass = FlowField;
            CalcFormula = Sum("FIN-Staff Advanc Surr. Details"."Cash Receipt Amount" WHERE("Surrender Doc No." = FIELD(No)));

        }
        field(68; "Actual Amount (LCY)"; Decimal)
        {
            CalcFormula = Sum("FIN-Staff Advanc Surr. Details"."Amount LCY" WHERE("Surrender Doc No." = FIELD(No)));
            FieldClass = FlowField;
        }
        field(69; "Commitment Status"; Boolean)
        {
        }
        field(70; "Difference Owed"; Decimal)
        {
