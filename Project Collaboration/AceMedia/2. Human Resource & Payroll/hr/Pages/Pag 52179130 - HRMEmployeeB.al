...
page 52179130 "HRM-Employee (B)"
{
    ...
    PromotedActionCategories = 'New,Process,Report,Additional Info,Attachments';
    ...
    layout
    {
        area(content)
        {
            ...
            group("General Information")
            {
                ...
                field("State Counsel"; Rec."State Counsel")
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the State Counsel field.';
                    Visible = false;
                }
            ...
            group("Personal Details")
            {
                ...
                field("Physical Disability"; Rec."Physical Disability")
                {
                    ...
                    trigger OnValidate()
                    begin
                        if Rec."Physical Disability" = true then begin
                ...
                field("KRA Certificate"; Rec."KRA Certificate")
                {
                    ApplicationArea = all;
                }
            ...
            group("Important Dates")
            {
                ...
                field("Annual Increament Date";Rec."Annual Increament Date")
                {
                    ApplicationArea = all;
            ...
            group(Leave)
            {
                ...
                field("Current Leave No"; Rec."Current Leave No")
                {
                    Editable = false;
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the Current Leave No field.';
                }
