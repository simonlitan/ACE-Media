...
//       END;
//   END  ELSE ERROR('%1%2%3%4%5%6','Missing Budget for  Account:',GLAccount.Name,' Department: ', DimensionValue.Name, ' available is ', FINBudgetEntries.Amount); 
// END;
...
// LOCAL GenerateBudgetEntries(PayPeriodz : Record "PRL-Payroll Periods")
