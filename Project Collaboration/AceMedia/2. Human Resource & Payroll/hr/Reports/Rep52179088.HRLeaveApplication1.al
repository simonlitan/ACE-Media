report 52179088 "HR Leave Application (1)"
{
    DefaultLayout = RDLC;
    RDLCLayout = './hr/Reports/SSR/HRLeaveApplication2.rdl';
    UseRequestPage = true;
    ...
    dataset
    {
        dataitem(DataItem9741; "HRM-Leave Requisition")
        {
            ...
            column(HR_Leave_Requisition__Department_Code_; "Institution Code")
            {
            }
            ...
            column(HR_Leave_Requisition__Department_Code_Caption; FIELDCAPTION("Institution Code"))
            {
            }
            ...
            // column(DepartmentCode; "Global Dimension 2 Code")
            // {
