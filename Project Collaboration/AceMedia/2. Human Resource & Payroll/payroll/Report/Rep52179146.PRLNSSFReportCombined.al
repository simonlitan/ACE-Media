report 52179146 "PRL-NSSF Report Combined"
{
    DefaultLayout = RDLC;
    RDLCLayout = './payroll/Report/SSR/PRL-NSSF Report Combined.rdl';
    ...
    dataset
    {
        dataitem("HRM-Employee C"; "HRM-Employee C")
        {
            ...
            column(GGtot; Gtoto * 2)
            {
            }
            column(NSSFAmount; NSSFAmount)
            { }
            column(AVCCont; AVCCont)
            { }
            ...
            begin
                ...
                PRLPeriodTransactions.RESET;
                PRLPeriodTransactions.SETRANGE(PRLPeriodTransactions."Employee Code", "HRM-Employee C"."No.");
                PRLPeriodTransactions.SETFILTER(PRLPeriodTransactions."Transaction Code", 'D-941');
                //PRLPeriodTransactions.SETRANGE(PRLPeriodTransactions."Group Text",'STATUTORIES');
                PRLPeriodTransactions.SETRANGE(PRLPeriodTransactions."Payroll Period", datefilter);
                IF PRLPeriodTransactions.FIND('-') THEN BEGIN
                    AVCCont := PRLPeriodTransactions.Amount;
                END;
                /*
                //Loan Interest
                PRLPeriodTransactions.RESET;
                ...
                */
                ...
                Gtoto := NSSFAmount * 2;//+PRLEmployerDeductions.Amount;
