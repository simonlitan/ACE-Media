page 52178680 "FIN-Receipt Header UP"
{
    Caption = 'Receipt';
    DeleteAllowed = false;
    PageType = Card;
        ...
        area(processing)
        {
            action(Print)
            {
                ...
                begin
                    ...
                    REPORT.RUN(Report::Receipts2, TRUE, TRUE, Rec);
                    Rec.RESET;
                    //52178741
                end;
            }
            action(Print2)
            {
                ...
                begin
                    ...
                    Rec.RESET;
                    Rec.SETFILTER("No.", Rec."No.");
                    REPORT.RUN(Report::Receipts, TRUE, TRUE, Rec);
                    Rec.RESET;
                    //52178741
                end;
            }
            action(Post)
            {
                ...
                begin
                    ...
                    // if Rec.Remarks  = '' then 
                    // Error('Receipt Description cannot be empty');
                    Rec.Cashier := USERID;
