codeunit 52179077 "HR Post Leave Journal Ent."
{
    ...
    begin
        ...
        IF hrLeaveJournal.FIND('-') THEN BEGIN
            ...
            REPEAT
                ...
                leaveLedger."Forfeited Leave" := ((hrLeaveJournal."Forfeited Days"));

                leaveLedger."Transaction Description" := hrLeaveJournal."Transaction Description";
                leaveLedger."Leave Period" := DATE2DWY(TODAY, 3);
                // leaveLedger."Leave Period" := Leaveperiods.Year;
                leaveLedger.INSERT;
                // hrLeaveJournal.Posted := true;
                hrLeaveJournal."Posting Date" := Today;
                hrLeaveJournal.Modify();
                lastNo := lastNo + 10;
