page 52178608 "FIN-Imprest List UP"
{
                ...
                IF FINBudgetEntries.FIND('-') THEN BEGIN
                    IF FINBudgetEntries.CALCSUMS(Amount) THEN BEGIN
                        IF FINBudgetEntries.Amount > 0 THEN BEGIN
                            ...
                            , FINImprestLines.Amount, FINImprestLines."Account Name", 'IMPREST',
                             Rec."No." + FINImprestLines."Account No." + '-' + Format(FINImprestLines."Line No."), Rec.Purpose);
                        END ELSE
        ...
        IF FINImprestLines.FIND('-') THEN BEGIN
            ...
            BEGIN
                ...
                IF (FINImprestLines.Amount > 0) THEN BEGIN
                    ...
                    FINImprestLines.Amount, FINImprestLines."Account Name", USERID, TODAY,
                      'IMPREST', Rec."No." + FINImprestLines."Account No." + '-' + Format(FINImprestLines."Line No."), Rec.Purpose);
                END;
            END;
            UNTIL FINImprestLines.NEXT = 0;
        END;
        ...
        IF FINImprestLines.FIND('-') THEN BEGIN
            ...
            BEGIN
                ...
                IF (FINImprestLines.Amount > 0) THEN BEGIN
                   ...
                   Rec."Shortcut Dimension 3 Code", FINImprestLines.Amount, FINImprestLines."Account Name", USERID, 'IMPREST',
                    Rec."No." + FINImprestLines."Account No." + '-' + Format(FINImprestLines."Line No."), Rec.Purpose);
                END;
            END;
            UNTIL FINImprestLines.NEXT = 0;
    ...
    begin
        IF Rec."Employee No" <> '' THEN BEGIN
            ...
            IF MemoHeader.GET(Rec."Employee No") THEN BEGIN
                MemoHeader.TESTFIELD(MemoHeader."Shortcut Dimension 3 Code");
                MemoHeader.TESTFIELD("Global Dimension 1 Code");
                MemoHeader.TESTFIELD("Global Dimension 2 Code");
                ...
                IF GLAccount.FIND('-') THEN GLAccount.TESTFIELD(Name);
                DimensionValue.RESET;
                DimensionValue.SETRANGE(Code, MemoHeader."Global Dimension 2 Code");
                DimensionValue.SETRANGE("Global Dimension No.", 3);
                IF DimensionValue.FIND('-') THEN DimensionValue.TESTFIELD(Name);
                IF (FINMemoDetails.Amount > 0) THEN BEGIN
                    // Commit Budget Here
                    PostBudgetEnties.CancelBudgetCommitment(MemoHeader."Budget Account", Rec.Date, Rec."Global Dimension 1 Code", MemoHeader."Global Dimension 2 Code",
                   Rec."Shortcut Dimension 3 Code", FINMemoDetails.Amount, GLAccount.Name, USERID, 'MEMO', MemoHeader."No." + MemoHeader."Budget Account", 'MEMO');
                END;
