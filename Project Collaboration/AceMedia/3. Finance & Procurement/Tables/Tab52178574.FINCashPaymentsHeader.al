table 52178574 "FIN-Cash Payments Header"
{
    //LookupPageID = 68569;
    ...
    fields
    {
        ...
        field(26; "Total Pending Voucher Amount"; Decimal)
        {
            CalcFormula = Sum("FIN-Cash Payment Line q"."Net Amount" WHERE(No = FIELD("No."),
        ...
        field(28; "Current Source A/C Bal."; Decimal)
        {
        }
        field(29; "Register Number"; Integer)
        {
        }
        field(30; "From Entry No."; Integer)
        {
        }
        field(31; "To Entry No."; Integer)
        {
        }
