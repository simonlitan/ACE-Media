report 52179179 "Payroll JVS Transfer"
{
    ProcessingOnly = true;
    ...
    dataset
    {
        dataitem(scard; "PRL-Salary Card")
        {
            ...
            begin
                ...
                IF objEmp.FIND('-') THEN
                    IF objEmp.Status = objEmp.Status::Inactive THEN
                        CurrReport.SKIP;
    ...
    var
        JVsheader: Record "Journal Voucher Header1";
        JVSLine: Record "Journals Voucher Lines1";
        JVSLine2: Record "Journals Voucher Lines1";
        JVHeader: code[30];
    ...
    begin
        ...
        JVSLine."Shortcut Dimension 1 Code" := GlobalDime1;
        JVSLine."Shortcut Dimension 2 Code" := 'HR';
