page 52179297 "PRL-Casuals Pay Card"
{
    ...
    SourceTableView = SORTING("No.")
                      ...
                      WHERE(Status = FILTER(Active),
                            "Employee Category" = FILTER('CASUALS'));
    ...
    layout
    {
        area(content)
        {
            ...
            part("Wage Computations"; "PRL-Casual Worked Days")
            {
                ApplicationArea = all;
                Caption = 'Wage Computations';
        ...
        area(reporting)
        {
            action(View2PagePayslip)
            {
                ...
                begin
                    ...
                    if SalCard.Find('-') then
                        REPORT.Run(Report::"Casual-Individual Payslips", true, false, SalCard);
                end;
            }
            action(ViewhorPayslip)
            {
                ...
                begin
                    ...
                    SalCard.SetRange("Current Instalment", objPeriod."Current Instalment");
                    if SalCard.Find('-') then
                        REPORT.Run(Report::"Casual- Payslip (Horizontal)", true, false, SalCard);
                end;
            }
            action("Bank Schedule")
            {
                ...
                Image = "Report";
                Promoted = true;
                //  RunObject = Report "Post Casual Salaries";
            }
            action("NHIF - Casual")
            {
                ApplicationArea = All;
            ...
            action("Casuals P9")
            {
                ...
                RunObject = Report "P9 Report (Final) Casuals";
            }
        }
        area(processing)
        {
                                    ...
                                    */
                                    ...
                                    if salaryCard.Find('-') then begin
                                        ...
                                        ProcessPayroll.fnProcesspayroll(HrEmployee."No.", DOJ, (salaryCard."Days Worked" * salaryCard."Daily Rate"), false
                                            ...
                                            dateofLeaving, GetsPAYERelief, '', HrEmployee."Payroll Code", true, objPeriod."Current Instalment");
