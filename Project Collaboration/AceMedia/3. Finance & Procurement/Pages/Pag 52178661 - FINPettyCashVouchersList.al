page 52178661 "FIN-Petty Cash Vouchers List"
{
                ...
                IF FINBudgetEntries.FIND('-') THEN BEGIN
                    IF FINBudgetEntries.CALCSUMS(Amount) THEN BEGIN
                        IF FINBudgetEntries.Amount > 0 THEN BEGIN
                            ...
                            FINPaymentLine.Amount, FINPaymentLine."Account Name", 'PV',
        ...
        IF FINPaymentLine.FIND('-') THEN BEGIN
            ...
            BEGIN
                ...
                IF (FINPaymentLine.Amount > 0) THEN BEGIN
                    // Commit Budget Here
                    PostBudgetEnties.ExpenseBudget(FINPaymentLine."Account No.", Rec.Date, rec."Global Dimension 1 Code",
                     Rec."Shortcut Dimension 2 Code",
    ...
    begin
        ...
        IF FINPaymentLine.FIND('-') THEN BEGIN
            ...
            BEGIN
                ...
                IF (FINPaymentLine.Amount > 0) THEN BEGIN
                    // Commit Budget Here
                    PostBudgetEnties.CancelBudgetCommitment(FINPaymentLine."Account No.", Rec.Date, Rec."Global Dimension 1 Code",
                    Rec."Shortcut Dimension 2 Code", Rec."Shortcut Dimension 3 Code", FINPaymentLine.Amount,
                    FINPaymentLine."Account Name", USERID, 'PV', Rec."No." + FINPaymentLine."Account No." + '-' + Format(FINPaymentLine."Line No."), Rec.Payee);
                END;
            END;
            UNTIL FINPaymentLine.NEXT = 0;
        END;
