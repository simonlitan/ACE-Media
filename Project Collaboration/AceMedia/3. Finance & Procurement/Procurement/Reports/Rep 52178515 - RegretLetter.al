report 52178572 "Regret Letter"
{
    RDLCLayout = './Procurement/Reports/Ssr/Regret Letter.rdl';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            DataItemTableView = where("Quote Status" = filter(<> "Recommended Award"));
            ...
            dataitem("Proc-Intention To Award"; "Proc-Intention To Award")
            {
                ...
                column(Date_ProcIntentionToAward; "Date")
                {
                }
                ...
                begin
                    Pline.Reset();
                    Pline.SetRange("Document No.", "Proc-Intention To Award"."Bidder No");
                    if Pline.Find('-') then begin
                        Pline.CalcSums("Line Amount");
                        BidAmount := Pline."Line Amount";
                        InitTextVariable;
                        FormatNoText(NumberText, BidAmount, CurrencyCodeText);
                    end;
                end;
