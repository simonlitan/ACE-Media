table 52179232 "PRL-Casual Period Transactions"
{
    ...
    fields
    {
        ...
        field(30; "Total Statutories"; Decimal)
        {
        ...
        field(31; "Employee Category"; Code[20])
        {
        ...
        field(33; "View on Payslip"; Boolean)
        {
        }
        field(34; "Group Section"; Option)
        {
            OptionCaption = ' ,Header,Lines,Footer';
            OptionMembers = " ",Header,Lines,Footer;
        }
        field(35; "Current Instalment"; Integer)
        {
        }
    }
