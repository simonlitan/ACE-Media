table 52178559 "FIN-Imprest Surrender Details"
{

    fields
    {
        field(1; "Surrender Doc No."; Code[80])
        {
            Editable = false;
            NotBlank = true;
        ...
        field(32; "Cash Surrender Amt LCY"; Decimal)
        {
        }
        field(33; "Imprest Req Amt LCY"; Decimal)
        {
        }
        field(34; "Cash Receipt Amount"; Decimal)
        {
        }
        field(35; "Cheque/Deposit Slip No"; Code[20])
        {
        ...
        field(36; "Cheque/Deposit Slip Date"; Date)
        {
        ...
        field(37; "Cheque/Deposit Slip Type"; Option)
        {
            OptionMembers = " "," Local","Up Country";
        }
        field(38; "Cheque/Deposit Slip Bank"; Code[20])
        {
            TableRelation = "Bank Account";
        }
        field(39; "Cash Pay Mode"; Option)
        {
        ...
        field(40; "Over Expenditure"; Decimal)
        {
        }
        field(41; "Line No."; Integer)
        {

        }
        field(42; "Budget Balance"; Decimal)
        {
            Editable = false;
        }
        field(43; "Budget Name"; Code[20])
        {

        }
        field(45; "Budget Allocation"; Decimal)
        {
              FieldClass = FlowField;
    ...
    keys
    {
        key(Key1; "Line No.", "Surrender Doc No.", "Account No:")
        {
            Clustered = true;
