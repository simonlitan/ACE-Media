Page 52178849 "Tender Awarded Card"
{
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            ...
            part(ST; "Tender Subm AwardL")

            {
                ApplicationArea = All;
                SubPageLink = "Document Type" = FIELD("Document Type"), "Tender No." = FIELD("No."), "Bid Status" = filter("Recommeded Award");
                Visible = bidVisable;
            }
        }
    }
        ...
        /* area(processing)
        {
            ...
            action(LoadDefaults)
            {
                ...
                begin
                    ...
                    Message('Default Setups Loaded Successfully');
                end;
            }
