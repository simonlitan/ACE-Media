page 52178752 "Fin- All Imprest"
{
    ...
    SourceTableView = sorting("No.") order(ascending) WHERE(Status = FILTER(<> Posted & <> Approved & <> Archive));
        ...
        IF FINImprestLines.FIND('-') THEN BEGIN
            ...
            BEGIN
                ...
                IF (FINImprestLines.Amount > 0) THEN BEGIN
                    // Commit Budget Here
                    PostBudgetEnties.ExpenseBudget(FINImprestLines."Account No.", Rec.Date, Rec."Global Dimension 1 Code",
                     Rec."Shortcut Dimension 2 Code", FINImprestLines.Amount,
                     FINImprestLines."Account Name", USERID, TODAY, 'IMPREST',
    ...
    begin
        ...
        IF FINImprestLines.FIND('-') THEN BEGIN
            ...
            BEGIN
                ...
                IF (FINImprestLines.Amount > 0) THEN BEGIN
                    // Commit Budget Here
                    PostBudgetEnties.CancelBudgetCommitment(FINImprestLines."Account No.", Rec.Date, Rec."Global Dimension 1 Code",
                     Rec."Shortcut Dimension 2 Code", Rec."Shortcut Dimension 3 Code", FINImprestLines.Amount,
                      FINImprestLines."Account Name", USERID, 'IMPREST',
                       Rec."No." + FINImprestLines."Account No." + '-' + Format(FINImprestLines."Line No."), Rec.Purpose);
                END;
            END;
            UNTIL FINImprestLines.NEXT = 0;
