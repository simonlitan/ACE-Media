table 52178602 "Payment Line"
{
    ...
    fields
    {
        ...
        field(100; "PAYE Code"; Code[20])
        {
            TableRelation = "Tariff Codes".Code WHERE(Type = CONST(PAYE));
        }
        field(101; "Budgeted Amount"; Decimal)
        {
        ...
        field(102; "Actual Expenditure"; Decimal)
        {
            FieldClass = FlowField;
        ...
        // field(103;"Committed Amount";Decimal)
        // {
        //     FieldClass = FlowField;
        ...
        // }
        field(104; "Budget Name"; Code[20])
        {
            TableRelation = "G/L Budget Name".Name;
        }
        field(105; "Budget Balance"; Decimal)
        {
        }
        field(106; "VAT Withheld Amount"; Decimal)
        {
        }
        field(107; "VAT Withheld Code"; Code[20])
        {
            TableRelation = "Tariff Codes".Code WHERE(Type = CONST(VAT));
        }
        field(108; "VAT Six % Rate"; Decimal)
        {
        }
        field(109; "Not Vatable"; Boolean)
        {
        }
        field(110; "Council No."; Code[20])
        {
