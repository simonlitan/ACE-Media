table 52178565 "FIN-Receipts and Payment Types"
{
    ...
    fields
    {
        ...
        {
            NotBlank = true;
            OptionMembers = " ",Receipt,Payment,Imprest,Claim,Advance,"Petty Cash";
        }
        ...
        field(30; Fuel; Boolean)
        {
        }
        field(31; "Advance Type"; Enum "Gen. Journal Account Type")
        {
        ...
        field(32; "Advance Grouping"; Code[20])
        {
        ...
        field(33; "Advance Name"; Text[100])
        {
