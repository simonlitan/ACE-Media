report 52178586 "Payment Voucher layout"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSR/Payment Voucher layout1.rdl';
    ...
    dataset
    {
        dataitem(PaymentHeader; "FIN-Payments Header")
        {
            ...
            dataitem("<Payment Line>"; "FIN-Payment Line")
            {
                ...
                column(TotalExpenseCommit; "Total Expense & Commitment")
                {

                }
                column(TotalExpenseCommit1; "Total Expense & Commitment1")
                {
                ...
                column(Total_Commitment1; "Total Commitment1")
                {

                }
                column(Total_Expense; "Total Expense")
                {

                }
                column(Total_Expense1; "Total Expense1")
                {
                ...
                column(Budget_Balance1; "Budget Balance1")
                {
    ...
    var
        ...
        budgetbal1: Decimal;
        BudgetAllocation1: Decimal;
        BudgetCommitment1: Decimal;
        BudgetBalAcct: Record "FIN-Budget Entries Summary";


        BudgetEntries: Record "FIN-Budget Entries";
        BudgetSummary: Record "FIN-Budget Entries Summary";
        BudgetBalAccNo: code[10];
