// report 52179109 "prPayrollJournalTransfer"
// {
//     ProcessingOnly = true;
...
//         end;
//         /* if GeneraljnlLine."Document No." = '' then begin
//             HrSetup.Get();
//             HrSetup.TestField(HrSetup."Document No");
//             NoSeriesMgt.InitSeries(HrSetup."Document No", GeneraljnlLine."No. Series", 0D, GeneraljnlLine."Document No.", GeneraljnlLine."No. Series");
//         end; */
//     end;
