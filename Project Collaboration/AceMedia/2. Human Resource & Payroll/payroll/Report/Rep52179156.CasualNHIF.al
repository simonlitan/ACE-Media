report 52179156 "Casual-NHIF"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Payroll/Report/SSR/CasualNHIF.rdl';
    ...
    dataset
    {
        dataitem("HRM-Employee C"; "HRM-Employee C")
        {
            ...
            column(prSalary_Card__prSalary_Card___Employee_Code_; "HRM-Employee C"."No.")
            {
            }
            column(Dob; Dob)
            {
            ...
            begin
                CLEAR(NhifAmount);
                objEmp.RESET;
                objEmp.SETRANGE(objEmp."No.", "HRM-Employee C"."No.");
                IF objEmp.FIND('-') THEN;
                ...
                PeriodTrans.RESET;
                PeriodTrans.SETRANGE(PeriodTrans."Employee Code", "HRM-Employee C"."No.");
