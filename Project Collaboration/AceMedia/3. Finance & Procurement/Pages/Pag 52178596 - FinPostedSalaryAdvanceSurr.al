page 52178596 "Fin-Posted Salary Advance Surr"
{
        ...
        IF FINStaffAdvancSurrDetails.FIND('-') THEN BEGIN
            ...
            BEGIN
                ...
                IF (FINStaffAdvancSurrDetails.Amount > 0) THEN BEGIN
                    // Commit Budget Here
                    PostBudgetEnties.ExpenseBudget(FINStaffAdvancSurrDetails."Account No:", Rec."Surrender Date", Rec."Global Dimension 1 Code",
                     Rec."Shortcut Dimension 2 Code", FINStaffAdvancSurrDetails.Amount,
                     FINStaffAdvancSurrDetails."Account Name", USERID, TODAY, 'ADVANCE',
