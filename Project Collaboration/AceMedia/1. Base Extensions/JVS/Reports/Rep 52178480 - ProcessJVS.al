report 52178480 "Process JVS"
{
    ...
    dataset
    {
        dataitem(Header; "Journal Voucher Header1")
        {
            ...
            dataitem(Lines; "Journals Voucher Lines1")
            {
    ...
    var
        ...
        OpHeader: Record "Journal Voucher Header1";
        OpLines: Record "Journals Voucher Lines1";
