page 52179274 "PRL-Rates & Ceilings"
{
    ...
    actions
    {
        area(Processing)
        {
            ...
            {
                ApplicationArea = all;
                RunObject = page "Employees Transaction";
            }
            action("SalaryCard Transaction")
            {
                ApplicationArea = all;
                RunObject = page "Salary Card List";
            }
        }
    }
