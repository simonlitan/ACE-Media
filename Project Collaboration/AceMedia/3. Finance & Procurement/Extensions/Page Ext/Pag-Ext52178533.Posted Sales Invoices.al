/// <summary>
/// PageExtension ExtPosted Sales Invoices (ID 52178506) extends Record Posted Sales Invoices.
/// </summary>
pageextension 52178533 "Posted Sales Invoices" extends "Posted Sales Invoices"
{
    actions
    {
        modify(print)
