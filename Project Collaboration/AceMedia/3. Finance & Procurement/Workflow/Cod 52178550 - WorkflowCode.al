codeunit 52178550 "Workflow Code"
{
    trigger OnRun()
    begin
    ...
    begin
        ...
        WorkflowEventHandling.AddEventToLibrary(RunWorkflowOnCancelledPVSApprovalCode(), Database::"Approval Entry", UserCanReqPVS, 0, false);
    ...
    begin
        ...
        WorkflowEventHandling.AddEventToLibrary(RunWorkflowOnCancelledMemoApprovalCode(), Database::"Approval Entry", UserCanReqMemo, 0, false);
    ...
    begin
        ...
        WorkflowResponseHandling.AddResponseToLibrary(CancMemoCode(), 0, UserCanReqMemo, 'GROUP 0')
    end;
    ...
    var
        ...
        BudgetCommit: Record "Journal Voucher Header";
    begin
        RecRef.GetTable(Variant);
        case RecRef.Number() of
