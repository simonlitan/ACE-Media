...
/// </summary>
report 52179105 "PR Payroll Summary - Variance"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("PRL-Transaction Codes"; "PRL-Transaction Codes")
        {
            ...
            column(TotalAmatEmplVariance; (pensionemmployercur + NSSFemmployercur + NSSFemmployercur1 + NSSFemmployercur2) - (pensionemmployerPrev + NSSFemmployerprev + NSSFemmployerPrev1 + NSSFemmployerPrev2))//NSSFemmployercurVariance + NSSFemmployercurVariance1 + NSSFemmployercurVariance2 + PensioAmtVariance)
            {
            ...
            column(TotalCurrEmployerAmt; pensionemmployercur + NSSFemmployercur + NSSFemmployercur1 + NSSFemmployercur2)
            {

            }
            column(TotalPrevEmployerAmt; pensionemmployerPrev + NSSFemmployerprev + NSSFemmployerPrev1 + NSSFemmployerPrev2)
            {
            ...
            column(CurrGrossNosSalary; CurrGrossNoSalary) { }
            column(CurrBasicSalary; CurrBasicSalary)
            {

            }
            column(CurrGrosSalary; CurrGrosSalary) { }
            ...
            column(PrevGrossNoSalary; PrevGrossNoSalary) { }
            column(PrevGrossSalary; PrevGrossSalary) { }
            column(BasicSalNoVariance; CurrBasicNoSalary - PrevBasicNoSalary)
            {

            }
            column(GrossSalNoVariance; CurrGrossNoSalary - PrevGrossNoSalary) { }





            column(GrosSalNoVariance; CurrGrossNoSalary - PrevGrossNoSalary) { }
            ...
            column(GrossSalAmtVariance; CurrGrosSalary - PrevGrossSalary) { }
            ...
            begin
                ...
                PRPeriodTrans.SetRange(PRPeriodTrans."Payroll Period", PeriodFilter);
                IF PRPeriodTrans.Find('-') then begin
                    CurrGrossNoSalary := PRPeriodTrans.Count;
                    PRPeriodTrans.CalcSums(Amount);
                    CurrGrosSalary := PRPeriodTrans.Amount;
                end;
                PRPeriodTrans.Reset;
                PRPeriodTrans.SetCurrentKey("Employee Code", "Transaction Code", "Period Month", "Period Year", Membership, "Reference No");
                PRPeriodTrans.SetRange(PRPeriodTrans."Transaction Code", 'GPAY');
                PRPeriodTrans.SetRange(PRPeriodTrans."Payroll Period", Variant_PeriodFilter);
                IF PRPeriodTrans.Find('-') then begin
                    PrevGrossNoSalary := PRPeriodTrans.Count;
                    PRPeriodTrans.CalcSums(Amount);
                    PrevGrossSalary := PRPeriodTrans.Amount;
                end;
                PRPeriodTrans.SetCurrentKey("Employee Code", "Transaction Code", "Period Month", "Period Year", Membership, "Reference No");
                ...
                PRPeriodTrans.Reset;
                PRPeriodTrans.SetCurrentKey("Employee Code", "Transaction Code", "Period Month", "Period Year", Membership, "Reference No");
                PRPeriodTrans.SetRange(PRPeriodTrans."Transaction Code", 'NSSF(I)');
                PRPeriodTrans.SetRange(PRPeriodTrans."Payroll Period", PeriodFilter);
                IF PRPeriodTrans.Find('-') then begin
                ...
                PRPeriodTrans.Reset;
                PRPeriodTrans.SetCurrentKey("Employee Code", "Transaction Code", "Period Month", "Period Year", Membership, "Reference No");
                PRPeriodTrans.SetRange(PRPeriodTrans."Transaction Code", 'NSSF(II)');
                PRPeriodTrans.SetRange(PRPeriodTrans."Payroll Period", PeriodFilter);
                IF PRPeriodTrans.Find('-') then begin
                ...
                Employerdeductions.SetRange("Transaction Code", 'D-002');
                ...
                Employerdeductions.Reset();
                Employerdeductions.SetCurrentKey("Employee Code", "Transaction Code", "Period Month", "Period Year", "Payroll Period");
                Employerdeductions.SetRange("Transaction Code", 'NSSF(I)');
                Employerdeductions.SetRange("Payroll Period", PeriodFilter);
                if Employerdeductions.Find('-') then begin
                ...
                Employerdeductions.Reset();
                Employerdeductions.SetCurrentKey("Employee Code", "Transaction Code", "Period Month", "Period Year", "Payroll Period");
                Employerdeductions.SetRange("Transaction Code", 'NSSF(II)');
                Employerdeductions.SetRange("Payroll Period", PeriodFilter);
                if Employerdeductions.Find('-') then begin
    ...
    var
        ...
        CurrGrosSalary: Decimal;
        CurrBasicNoSalary: Integer;
        CurrGrossNoSalary: Integer;
        PrevBasicNoSalary: Integer;
        PrevGrossNoSalary: Integer;
        PrevGrossSalary: Decimal;
        ...
        GrossSalNoVariance: Decimal;
        GrossSalAmtVariance: Decimal;
