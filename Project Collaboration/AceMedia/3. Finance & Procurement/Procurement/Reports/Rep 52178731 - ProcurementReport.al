report 52178731 "Procurement Report1"
{
    Caption = 'Procurement Order Report';
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = './Procurement/Reports/SSR/ProcurementOrderReport.rdl';
    dataset
    {
        dataitem(PurchaseHeader; "Purchase Header")
        {
            ...
            column(Shortcutdimension4_PurchaseHeader; "Shortcut dimension 4 Code")
            {
            }
