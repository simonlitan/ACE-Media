...
//             if empTr.Get() then begin
//                 clear(SubGroupCount);
//                 repeat
//                     SubGroupCount += 1;
//                     fnUpdatePeriodTrans(strEmpCode, empTr."Transaction Code", CopyStr(empTr."Transaction Name", 1), 16, SubGroupCount, 'Housing Levi Contrib Employer', HousingLevy + empTr.Amount, 0, intMonth,
...
//             end else begin
//                 fnUpdatePeriodTrans(strEmpCode, empTr."Transaction Code", empTr."Transaction Name", 16, 0, 'Housing Levi Contrib Employer', HousingLevy, 0, intMonth,
//              intYear, '', prPeriodTransactions."Reference No", SelectedPeriod, Dept, '5000069', JournalPostAs::" ", JournalPostingType::" ", '', CoopParameters::none);
...
//                                             P9NSSF1 := prPeriodTransactions.Amount else
