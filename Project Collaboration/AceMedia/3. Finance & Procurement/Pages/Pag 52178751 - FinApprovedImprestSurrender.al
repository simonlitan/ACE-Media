page 52178751 "Fin-Approved Imprest Surrender"
{
    ...
    SourceTableView = sorting("No") order(ascending) WHERE(Status = const(Approved));
        ...
        IF FINImprestSurrLines.FIND('-') THEN BEGIN
            ...
            BEGIN
                ...
                IF (FINImprestSurrLines.Amount > 0) THEN BEGIN
                    // Commit Budget Here
                    PostBudgetEnties.ExpenseBudget(FINImprestSurrLines."Account No:", Rec."Surrender Date", Rec."Global Dimension 1 Code", Rec."Shortcut Dimension 2 Code",
                     FINImprestSurrLines.Amount, FINImprestSurrLines."Account Name", USERID, TODAY,
                    'IMPREST', Rec."Imprest Issue Doc. No" + FINImprestSurrLines."Account No:" + '-' + Format(FINImprestSurrLines."Line No."), '');
                END;
            END;
