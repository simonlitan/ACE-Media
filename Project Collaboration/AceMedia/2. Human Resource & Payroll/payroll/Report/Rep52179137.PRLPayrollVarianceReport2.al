report 52179137 "PRL-Payroll Variance Report2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Payroll/report/ssr/PRL-Payroll Variance Report2.rdl';

    dataset
    {
        dataitem("PRL-Variance Trans. Code Buff";
        "PRL-Variance Trans. Code Buff")
        {
            column(CompName;
            compInfo.Name)
            {
            ...
            column(TransCode;
            "PRL-Variance Trans. Code Buff"."Transaction Code")
            {
            }
            column(EmpCode;
            "PRL-Variance Trans. Code Buff"."Emp. Code")
            {
            }
            column(TransName;
            "PRL-Variance Trans. Code Buff"."Transaction Name")
            {
            }
            column(EmpName;
            "PRL-Variance Trans. Code Buff"."Emp. Name")
            {
            }
            column(CurrAmount;
            "PRL-Variance Trans. Code Buff"."Current Amount")
            {
            }
            column(PrevAmount;
            "PRL-Variance Trans. Code Buff"."Previous Amount")
            {
            }
            column(CurrPeriod;
            PRLPayrollPeriodsCurr."Period Name")
            {
            }
            column(PrevPeriod;
            PRLPayrollPeriodsPrev."Period Name")
            {
            }
            column(variance;
            "PRL-Variance Trans. Code Buff"."Current Amount" - "PRL-Variance Trans. Code Buff"."Previous Amount")
            {
            }
