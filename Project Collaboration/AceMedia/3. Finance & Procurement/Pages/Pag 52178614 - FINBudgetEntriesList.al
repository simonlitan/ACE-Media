page 52178614 "FIN-Budget Entries List"
{
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Original DocNo"; Rec."Original DocNo")
                {
                    ApplicationArea = all;
                }
                ...
                field("Payees Name"; Rec."Payees Name")
                {
                    ApplicationArea = all;
                }
    ...
    actions
    {
        area(Navigation)
        {
            ...
            {
                ApplicationArea = all;
                RunObject = page "Budget Del Commitment";
            }
        }
    }
        ...
        IF PurchaseLine.FIND('-') THEN BEGIN
            ...
            BEGIN
                ...
                IF (PurchaseLine."Line Amount" > 0) THEN BEGIN
                    ...
                    PurchaseHeader."Shortcut Dimension 2 Code", PurchaseLine."Line Amount", PurchaseLine.Description,
                    USERID, TODAY, 'Invoice', PurchaseHeader."No." + PurchaseLine."No.", PurchaseLine."Description 2");
                END;
            END;
            UNTIL PurchaseLine.NEXT = 0;
        END;
