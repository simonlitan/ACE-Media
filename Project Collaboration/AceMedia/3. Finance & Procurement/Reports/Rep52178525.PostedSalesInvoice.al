/// <summary>
/// Report Posted Sales Invoice (ID 52178717).
/// </summary>
report 52178525 "Posted Sales Invoice"
{
    WordLayout = './Reports/SSR/SalesInvoice.docx';
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(HSCodes_Header; "HS Codes")
            {
            }
            ...
            column(DocumentDate_Header; Format("Document Date"))
            {
            }
            column(DocumentDate_DueDate; Format("Due Date"))
            {
            }
            ...
            column(CustHsCodes; CustHsCodes)
            {
            ...
            dataitem(Line; "Sales Invoice Line")
            {
                ...
                column(LineAmountLCY; LineAmountLCY)
                {
                    DecimalPlaces = 0 : 2;
                }
                ...
                dataitem(ShipmentLine; "Sales Shipment Buffer")
                {
                    ...
                    UseTemporary = true;
                    column(DocumentNo_ShipmentLine;
                    "Document No.")
                    {
                    }
                ...
                begin
                    ...
                    if Header."Currency Factor" > 0 then begin
                        LineAmountLCY := Line."Line Amount" / Header."Currency Factor";
                    end;
                end;
            ...
            dataitem(Totals; "Integer")
            {
                ...
                column(TotalAmountIncludingVATLCY; TotalAmountInclVATinLCY)
                {
                    DecimalPlaces = 0 : 2;
                }
                ...
                begin
                    ...
                    if Header."Currency Factor" > 0 then begin
                        TotalAmountInclVATinLCY := TotalAmountInclVAT / Header."Currency Factor";
                    end
                    else
                        TotalAmountInclVATinLCY := TotalAmountInclVAT;
                end;
            }
            ...
            begin
                ...
                if cust.Find('-') then begin
                    custPin := Cust."VAT Registration No.";
                    CustAddress := Cust.Address;
                    CustPhone := Cust."Phone No.";
                    CustEmail := Cust."E-Mail";
                    CustName := cust.Name;
                    CustHsCodes := cust."HS Code";
    ...
    var
        ...
        TotalAmountInclVATinLCY: Decimal;
