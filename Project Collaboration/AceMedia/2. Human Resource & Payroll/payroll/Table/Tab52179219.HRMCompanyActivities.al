table 52179219 "HRM-Company Activities"
{
    ...
    fields
    {
        ...
        field(11; "Email Message"; Text[250])
        {
        }
        ...
        field(14; "Contribution Amount (If Any)"; Decimal)
        {
        }
        field(15; "Activity Status"; Option)
        {
            OptionCaption = 'Planning,On going,Complete';
            OptionMembers = Planning,"On going",Complete;
        }
        field(16; "G/L Account Name"; Text[50])
        {
        }
