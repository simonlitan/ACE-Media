codeunit 52178538 "Post Budget Enties"
{
    ...
    begin
        ...
        IF GLBudgetEntry.FIND('-') THEN BEGIN
            ...
            FINBudgetEntriesSummary.DELETEALL;
            CLEAR(LastItem);
            REPEAT
            BEGIN
                ...
                FINBudgetEntriesSummary.SetRange("Global Dimension 3 Code", GLBudgetEntry."Budget Dimension 3 Code");
                ...
                IF NOT FINBudgetEntriesSummary.FIND('-') THEN BEGIN
                    ...
                    FINBudgetEntriesSummary."Global Dimension 3 Code" := GLBudgetEntry."Budget Dimension 3 Code";
                ...
                UpdatePercentages(GLBudgetEntry."G/L Account No.", GLBudgetEntry."Global Dimension 1 Code",
    ...
    procedure CheckBudgetAvailability(GLAccount: Code[40]; Dates: Date; GlobalDim1Code: Code[20]; GlobalDim2Code: Code[20]; Amounts: Decimal; Descriptions: Text; DocumentType: Code[20]; DocumentNo: Code[300]; DocumentDescription: Text[250])
    ...
    procedure Decommit(GLAccount: Code[40]; Dates: Date; GlobalDim1Code: Code[20]; GlobalDim2Code: Code[20]; Amounts: Decimal; Descriptions: Text; DocumentType: Code[20]; DocumentNo: Code[300]; DocumentDescription: Text[250])
    ...
    begin
        ...
        FINBudgetEntries.SETRANGE("Document No", DocumentNo);
        FINBudgetEntries.SETFILTER(FINBudgetEntries."Commitment Status", '<>%1', FINBudgetEntries."Commitment Status"::Cancelled);
        IF FINBudgetEntries.FIND('-') THEN
        //ERROR('Budget already checked!');
         Begin
            CLEAR(LastItem);
            FINBudgetEntries.RESET;
            IF FINBudgetEntries.FIND('+') THEN LastItem := FINBudgetEntries."Entry No.";
    ...
    procedure CheckBudgetAvailabilityGlobal(GLAccount: Code[40]; Dates: Date; Amounts: Decimal; Descriptions: Text; DocumentType: Code[20]; DocumentNo: Code[200]; DocumentDescription: Text[250])
    begin
        //Update Budget First
        IF checkBudgetControl(GLAccount) = FALSE THEN EXIT;
        PostBudget;
        ...
        BEGIN
            ...
            FINBudgetEntries.INSERT;
        END;
        UpdatePercentages(GLAccount, GLBudgetEntry."Global Dimension 1 Code", GLBudgetEntry."Global Dimension 2 Code");
    end;

    //[Scope('Internal')]
    procedure CancelBudgetCommitment(GLAccount: Code[40]; Dates: Date; GlobalDim1Code: Code[20]; GlobalDim2Code: Code[20]; GlobalDim3Code: Code[20]; Amounts: Decimal; Descriptions: Text; UserID: Code[20]; DocumentType: Code[20]; DocumentNo: Code[200]; DocumentDescription: Text[250])
    begin
    ...
    procedure CancelBudgetCommitmentGlobal(GLAccount: Code[40]; Dates: Date; Amounts: Decimal; Descriptions: Text; UserID: Code[20]; DocumentType: Code[20]; DocumentNo: Code[200]; DocumentDescription: Text[250])
    begin
    ...
    procedure ExpenseBudget(GLAccount: Code[40]; Dates: Date; GlobalDim1Code: Code[20]; GlobalDim2Code: Code[20]; Amounts: Decimal; Descriptions: Text; UserID: Code[20]; LastDateModified: Date; DocumentType: Code[20]; DocumentNo: Code[200]; DocumentDescription: Text[250])
    begin
        ...
        IF (FINBudgetEntries.FIND('-')) THEN BEGIN
            ...
            // IF (FINBudgetEntries2.FIND('-')) THEN
            //     FINBudgetEntries2.DeleteAll();
            //ERROR('No pending commitment found in the filters')
            // END;
            ...
            END;
            UpdatePercentages(GLAccount, GlobalDim1Code, GlobalDim2Code);
            MESSAGE('Budget Expensed successifully');
        end;
    end;

    procedure ExpenseBudgetGlobal(GLAccount: Code[40]; Dates: Date; Amounts: Decimal; Descriptions: Text; UserID: Code[20]; LastDateModified: Date; DocumentType: Code[200]; DocumentNo: Code[200]; DocumentDescription: Text[250])
    ...
    begin
        ...
        FINBudgetEntries.SETRANGE("Document No", DocumentNo);
        FINBudgetEntries.SETRANGE("Document Type", DocumentType);
        FINBudgetEntries.SETFILTER(FINBudgetEntries."Commitment Status", '%1|%2', FINBudgetEntries."Commitment Status"::Commitment, FINBudgetEntries."Commitment Status"::"Commited/Posted");
        IF NOT FINBudgetEntries.FIND('-') THEN BEGIN
            //Try Commiting Budget Again
            CheckBudgetAvailabilityGlobal(GLAccount, Dates, Amounts, Descriptions, DocumentType, DocumentNo, DocumentDescription);
            FINBudgetEntries2.RESET;
            FINBudgetEntries2.SETRANGE("Budget Name", GetCurrentBudget);
            FINBudgetEntries2.SETRANGE("Document No", DocumentNo);
            FINBudgetEntries2.SETRANGE("Document Type", DocumentType);
            FINBudgetEntries2.SETFILTER(FINBudgetEntries2."Commitment Status", '%1|%2', FINBudgetEntries2."Commitment Status"::Commitment, FINBudgetEntries2."Commitment Status"::"Commited/Posted");
        ...
        IF FINBudgetEntries.FIND('+') THEN LastItem := FINBudgetEntries."Entry No.";
        BEGIN
            if (FINBudgetEntries."Commitment Status" = FINBudgetEntries."Commitment Status"::Commitment) or (FINBudgetEntries."Commitment Status" = FINBudgetEntries."Commitment Status"::"Commited/Posted") then begin
                LastItem := LastItem + 1;
                FINBudgetEntries.INIT;
                FINBudgetEntries."Entry No." := LastItem;
                FINBudgetEntries."Budget Name" := GetCurrentBudget;
