table 52179183 "Casuals Attendance Ledger"
{
    ...
    fields
    {
        ...
        {
            TableRelation = "HRM-Employee C"."No." WHERE("Employee Category" = FILTER('CASUAL' | 'CASUALS'));
        ...
        field(18; "Payroll Month"; Integer)
        {
        }
        field(19; "Payroll Year"; Integer)
        {
        }
    }
