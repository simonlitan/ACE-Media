table 52179199 "PRL-Employee Transactions"
{
    ...
    fields
    {
        ...
        field(2; "Transaction Code"; Code[100])
        {
        ...
        field(3; "Transaction Name"; Text[200])
        {
        }
        ...
        {
            TableRelation = "PRL-Payroll Periods"."Period Month";
        }
        ...
        {
            CalcFormula = Count("HRM-Employee C" WHERE("No." = FIELD("Employee Code"), Status = FILTER(Active)));
            FieldClass = FlowField;
        }
        ...
        {
            CalcFormula = Lookup("HRM-Employee C".Status WHERE("No." = FIELD("Employee Code")));
            FieldClass = FlowField;
            OptionCaption = 'Active,Inactive,Normal,Resigned,Discharged,Retrenched,Pension,Disabled';
            OptionMembers = Active,Inactive,Normal,Resigned,Discharged,Retrenched,Pension,Disabled;
        }
    ...
    local procedure CalculateAmountBasedonDays()
    var
