report 52178714 "RFQ Report1"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Procurement/Reports/SSR/RFQReport.rdl';
    ...
    dataset
    {
        dataitem("PROC-Quotation Request Vendors"; "PROC-Quotation Request Vendors")
        {
            ...
            dataitem("PROC-Purchase Quote Header"; "PROC-Purchase Quote Header")
            {
                ...
                column(PostingDescription_PurchaseQuoteHeader; "PROC-Purchase Quote Header"."Description")
                {
                }
