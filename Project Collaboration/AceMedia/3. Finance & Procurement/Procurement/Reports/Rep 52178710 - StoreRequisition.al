report 52178710 "Store Requisition1"
{
    DefaultLayout = RDLC;
    UsageCategory = ReportsAndAnalysis;
    RDLCLayout = './Procurement/Reports/SSR/StoreRequisition.rdl';
    ...
    dataset
    {
        dataitem(SRN; "PROC-Store Requistion Header")
        {
            ...
            column(UserID_SRN; "User ID")
            {
            }

            column(Issuer_SRN; Issuer)
            {
            }
            column(IssueDate_SRN; "Issue Date")
            {
            }
            ...
            column(Storebalance; SRNLines."In store")
            {
            }
            ...
            dataitem(SRNLines; "PROC-Store Requistion Lines")
            {
                ...
                column(Issued; SRNLines."Quantity Issued")
                {
                }
                ...
                column(Qtybalance_SRNLines; "Qty balance")
                {
                }
                column(InStore_SRNLines; "In Store")
                {
                }
            ...
            dataitem(ApprovalEntry; "Approval Entry")
            {
                ...
                dataitem(UserSetUp; "User Setup")
                {
                    ...
                    begin
                        ...
                        // ApprovalEntry.SetFilter(ApprovalEntry."Approver ID", '<>%1', ph.Cashier);
                    end;
                }
            }
    ...
    begin
        ...
        IF info.FIND('-') THEN BEGIN
            ...
            SRNLines.CalcFields(SRNLines."In Store");
