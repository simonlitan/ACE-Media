report 52179161 "Casual-Deductions Summary 2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Payroll/Report/SSR/CasualDeductionsSummary2.rdl';
    ...
    dataset
    {
        dataitem("PRL-Casual Period Transactions"; "PRL-Casual Period Transactions")
        {
            ...
            begin
                ...
                IF NOT (((("PRL-Casual Period Transactions"."Group Order" = 7) AND
                     (("PRL-Casual Period Transactions"."Sub Group Order" <> 6)
                    AND ("PRL-Casual Period Transactions"."Sub Group Order" <> 5))) OR
                    (("PRL-Casual Period Transactions"."Group Order" = 8) AND
                     ("PRL-Casual Period Transactions"."Sub Group Order" <> 9)))) THEN BEGIN
                    CurrReport.SKIP;
                END;
            ...
            begin
                ...
                "PRL-Casual Period Transactions".SETFILTER("PRL-Casual Period Transactions"."Current Instalment", '=%1', NoOfInstalment);
            end;
        }
    }
    ...
    var
        ...
        "prPayroll Periods": Record "PRL-Casual Payroll Periods";
}
