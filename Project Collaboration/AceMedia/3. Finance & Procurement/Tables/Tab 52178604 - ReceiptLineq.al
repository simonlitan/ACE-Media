table 52178604 "Receipt Line q"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Account No.';
            TableRelation = IF ("Account Type" = CONST("G/L Account")) "G/L Account" WHERE("Direct Posting" = filter(false))
            ELSE
        ...
        field(33; "Gen. Posting Type"; Enum "General Posting Type")
        {
        ...
        field(78; "Shortcut Dimension 3 Code"; Code[20])
        {
            CaptionClass = '1,2,3';
        ...
        field(79; "Shortcut Dimension 4 Code"; Code[20])
        {
            CaptionClass = '1,2,4';
        ...
        field(80; "Applies-to Doc. Type"; Option)
        {
            Caption = 'Applies-to Doc. Type';
            OptionCaption = ' ,Payment,Invoice,Credit Memo,Finance Charge Memo,Reminder,Refund';
            OptionMembers = " ",Payment,Invoice,"Credit Memo","Finance Charge Memo",Reminder,Refund;
        }
        field(81; "Applies-to Doc. No."; Code[20])
        {
        ...
        field(82; "Applies-to ID"; Code[20])
        {
    ...
    begin
        ...
        IF CustLedgEntry.FINDFIRST THEN BEGIN
            ...
            //UN(CODEUNIT::"Cust. Entry-Edit", CustLedgEntry);
        END;
    end;
}