page 52178621 "FIN-Imprests Requisition"
{
    CardPageID = "FIN-Travel Advance Requisition";
    Editable = false;
    PageType = List;
    InsertAllowed = false;
    DelayedInsert = false;
            ...
            BEGIN
                ...
                IF (FINImprestLines.Amount > 0) THEN BEGIN
                    ...
                    PostBudgetEnties.CancelBudgetCommitment(FINImprestLines."Account No.", Rec.Date, Rec."Global Dimension 1 Code",
                     Rec."Shortcut Dimension 2 Code", Rec."Shortcut Dimension 3 Code", FINImprestLines.Amount, FINImprestLines."Account Name",
                      USERID, 'IMPREST', Rec."No." + FINImprestLines."Account No.", Rec.Purpose);
                END;
            END;
            UNTIL FINImprestLines.NEXT = 0;
        END;
