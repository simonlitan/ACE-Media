codeunit 52179081 "TrainReq Work Flow"
{
    trigger OnRun()
    begin
    ...
    var
        ...
        UserCanTrainReq: TextConst ENU = 'Approval Request for Training  is cancelled by user',
          ENG = 'Approval Request for Training is cancelled by user';
