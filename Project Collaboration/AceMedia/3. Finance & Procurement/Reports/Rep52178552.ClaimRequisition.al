report 52178552 "Claim Requisition"
{
    Caption = 'Claim Requisition Report';
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSR/ClaimRequisitionReport.rdl';

    dataset
    {
        dataitem(Claims_Header; "FIN-Staff Claims Header")
        {
            column(No_; Claims_Header."No.")
            {

            }
            column(Payee; Claims_Header.Payee)
            {

            }
            column(PF_No; Claims_Header."Account No.")
            {
            ...
            column(Purpose; Claims_Header.Purpose)
            {

            }
            column(Total_Net_Amount; Claims_Header."Total Net Amount")
            {

            }
            column(GlobalDimension1Code_Claims_Header; "Global Dimension 1 Code")
            {
            }
            column(ShortcutDimension2Code_Claims_Header; "Shortcut Dimension 2 Code")
            {
            }
            column(ShortcutDimension3Code_Claims_Header; "Shortcut Dimension 3 Code")
            {
            }
            column(Cashier_Claims_Header; Cashier)
            {
            }
            column(PaymentReleaseDate_Claims_Header; "Payment Release Date")
            {
            }
            column(BankName_Claims_Header; "Bank Name")
            {
            }
            column(DocumentType_Claims_Header; "Document Type")
            {
            }
            column(OnBehalfOf_Claims_Header; "On Behalf Of")
            {
            }
            column(PayMode_Claims_Header; "Pay Mode")
            {
            }
            column(RequestedAmount_Claims_Header; "Requested Amount")
            {
            }
            ...
            dataitem("FIN-Staff Claim Lines"; "FIN-Staff Claim Lines")
            {
                DataItemLink = "Document No." = field("No.");
                column(AccountNo_FINStaffClaimLines; "Account No.")
                {
                }
                column(AccountName_FINStaffClaimLines; "Account Name")
                {
                }
                column(ActualSpent_FINStaffClaimLines; "Actual Spent")
                {
                }
                column(AdvanceType_FINStaffClaimLines; "Advance Type")
                {
                }
                column(Amount_FINStaffClaimLines; Amount)
                {
                }
                column(ClaimReceiptNo_FINStaffClaimLines; "Claim Receipt No")
                {
                }
                column(Purpose_FINStaffClaimLines; Purpose)
                {
                }
            }
            ...
            begin
                ...
                //CheckReport.FormatNoText(NumberText, Total_Net_Amount, '');
