table 52179172 "prMassPCAHD"
{
    ...
    begin
        ...
        objLines.RESET;
        objLines.SETRANGE(objLines."Change Advice Serial No.", objEmpTransPCA."Change Advice Serial No.");
        IF objLines.FIND('-') THEN begin
            ...
            IF objemp.FIND('-') THEN BEGIN
                ...
                begin
                    ...
                    objTransCodes.Reset();
                    objTransCodes.SetRange("Transaction Code", objLines."Transaction Code");
                    if objTransCodes.Find('-') then
                        objLines."Transaction Name" := objTransCodes."Transaction Name";
                    objLines.Insert();
                    Commit();
                end;
