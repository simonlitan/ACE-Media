// codeunit 52178425 "Post Budget Enties"
// {
...
//     procedure CheckBudgetAvailability(GLAccount: Code[30]; Dates: Date; GlobalDim1Code: Code[20]; GlobalDim2Code: Code[20]; Amounts: Decimal; Descriptions: Text; DocumentType: Code[20]; DocumentNo: Code[30]; DocumentDescription: Text[250])
...
//     procedure CheckBudgetAvailabilityGlobal(GLAccount: Code[20]; Dates: Date; Amounts: Decimal; Descriptions: Text; DocumentType: Code[20]; DocumentNo: Code[20]; DocumentDescription: Text[250])
//     begin
//         //Update Budget First
//         IF checkBudgetControl(GLAccount) = FALSE THEN EXIT;
//         PostBudget;
...
//     //[Scope('Internal')]
//     procedure CancelBudgetCommitment(GLAccount: Code[20]; Dates: Date; GlobalDim1Code: Code[20]; GlobalDim2Code: Code[20]; GlobalDim3Code: Code[20]; Amounts: Decimal; Descriptions: Text; UserID: Code[20]; DocumentType: Code[20]; DocumentNo: Code[20]; DocumentDescription: Text[250])
//     begin
...
//     procedure CancelBudgetCommitmentGlobal(GLAccount: Code[20]; Dates: Date; Amounts: Decimal; Descriptions: Text; UserID: Code[20]; DocumentType: Code[20]; DocumentNo: Code[20]; DocumentDescription: Text[250])
//     begin
...
//     procedure ExpenseBudgetGlobal(GLAccount: Code[20]; Dates: Date; Amounts: Decimal; Descriptions: Text; UserID: Code[20]; LastDateModified: Date; DocumentType: Code[20]; DocumentNo: Code[20]; DocumentDescription: Text[250])
//     begin
