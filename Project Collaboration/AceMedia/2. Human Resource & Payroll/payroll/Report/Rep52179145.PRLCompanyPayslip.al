report 52179145 "PRL-Company Payslip"
{
    DefaultLayout = RDLC;
    RDLCLayout = './payroll/Report/SSR/PRL-Company Payslip.rdl';
        ...
        dataitem("PRL-Payroll Periods"; "PRL-Payroll Periods")
        {
            ...
            begin
                ...
                if prPeriod_Transactions.Find('-') then begin
                    Clear(DetDate);
                    DetDate := Format("PRL-Payroll Periods"."Period Name");
                    repeat
                    begin
    ...
    var
        ...
        NoOfColumns: Integer;
        ColumnNo: Integer;
        prPeriod_Transactions: Record "PRL-Period Transactions";
}
