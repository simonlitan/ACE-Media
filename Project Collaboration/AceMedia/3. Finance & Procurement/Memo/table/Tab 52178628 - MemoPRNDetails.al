table 52178628 "Memo PRN Details"
{
    ...
    fields
    {
        ...
        field(10; "Description 2"; Text[100])
        {
        ...
        field(14; "Unit Cost (LCY)"; Decimal)
        {
            AutoFormatType = 2;
            Caption = 'Unit Cost ($)';
        }
        ...
        field(21; "Use Duplication List"; Boolean)
        {
        ...
        field(24; Nonstock; Boolean)
        {
            AccessByPermission = TableData "Nonstock Item" = R;
            Caption = 'Nonstock';
        }
        field(25; "Purchasing Code"; Code[10])
        {
        ...
        field(27; "Planned Receipt Date"; Date)
        {
        ...
        field(29; "Manually Added"; Boolean)
        {
        }
        field(30; "RFQ Remarks"; Text[50])
        {
        }
        field(31; "Requisition No"; Code[20])
        {
        }
        field(32; "MPS Order"; Boolean)
        {
            Caption = 'MPS Order';
        }
    }
