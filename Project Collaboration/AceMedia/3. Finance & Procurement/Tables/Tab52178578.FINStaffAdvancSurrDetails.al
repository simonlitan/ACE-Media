table 52178578 "FIN-Staff Advanc Surr. Details"
{
    ...
    fields
    {
        ...
        field(36; Committed; Boolean)
        {
        }
        field(37; "Budgetary Control A/C"; Boolean)
        {
        }
        field(38; "Line on Original Document"; Boolean)
        {
        }
        field(39; "Allow Overexpenditure"; Boolean)
        {
        }
        field(40; "Open for Overexpenditure by"; Code[20])
        {
        }
        field(41; "Date opened for OvExpenditure"; Date)
        {
        }
        field(42; "Actual Receipt Amount"; Decimal)
        {
        }
        field(43; "Difference Owed"; Decimal)
        {
        }
    }
