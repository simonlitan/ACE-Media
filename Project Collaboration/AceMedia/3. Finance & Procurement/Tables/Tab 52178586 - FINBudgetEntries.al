table 52178586 "FIN-Budget Entries"
{
    Caption = 'G/L Budget Entry';
    DrillDownPageID = "FIN-Budget Entries List";
    // DrillDownPageId = "FIN-Budgetary Comparison List";
    LookupPageID = "FIN-Budget Entries List";
    ...
    fields
    {
        ...
        field(17; "Transaction Type"; Option)
        {
            DataClassification = ToBeClassified;
            OptionCaption = ' ,Allocation,Commitment,Expense,Revision';
            OptionMembers = " ",Allocation,Commitment,Expense,Revision;
        }
        field(18; "Commitment Status"; Option)
        {
            DataClassification = ToBeClassified;
            OptionCaption = ' ,Commitment,Commited/Posted,Cancelled';
            OptionMembers = " ",Commitment,"Commited/Posted",Cancelled;
        }
        field(19; "Document Type"; Code[20])
        {
            DataClassification = ToBeClassified;
        }
        field(20; "Document No"; Code[100])
        {
            DataClassification = ToBeClassified;
        }
        field(21; "Document Description"; Text[250])
        {
            DataClassification = ToBeClassified;
        }
        field(22; "Payees Name"; Code[100])
        {
            FieldClass = FlowField;
            CalcFormula = lookup("G/L Entry".Description where("Document No." = field("Document No")));
            // CalcFormula = lookup("FIN-Imprest Header".Payee where("No." = field("Document No")));
        ...
        field(25; "Original DocNo"; Code[20])
        {
