report 52178582 "Imprest Surrender"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSR/ImprestAccountingNepad.rdl';
    dataset
    {
        dataitem(impSurrHead; "FIN-Imprest Surr. Header")
        {
            ...
            // }
            // column(Approve1; Approve1){ }
            // dataitem(ImpHeader; "FIN-Imprest Header")
            // {
            ...
            //     column(Approval_Title; "Approval Title")
            //     {
            ...
            dataitem(ImpSurrDetails; "FIN-Imprest Surrender Details")
            {
                ...
                column(CommitExpense; "Budget Allocation" - "Budget Balance")
                {

                }
                column(CurrentBal; "Budget Balance" + Amount)
                { }
            ...
            dataitem(ApprovalEntry; "Approval Entry")
            {
                ...
                DataItemLinkReference = impSurrHead;
                ...
                dataitem(UserSetUp1; "User Setup")
                {
                    ...
                    // column(User1; User1."User Signature")
                    // {
                    // }
           ...
           Trigger OnAfterGetRecord()
                Begin
                    // Approval1.Reset();
                    // Approval1.setrange("Document No.", Surheader.No);
                    // Approval1.setrange(Status, Approval1.Status::Approved);
                    // //Approval1.SetFilter("Sequence No.", '%1', 1);
                    // if Approval1.Find('-') then begin
                    //     Approve1 := Approval1."Approver ID";

                           //approval entry 1st approver
                ApprovalEntry1.Reset();
                ApprovalEntry1.SetRange("Document No.", impSurrHead.No);
                ...
                ApprovalEntry2.SetRange("Document No.", impSurrHead.No);
                ...
                ApprovalEntry3.SetRange("Document No.", impSurrHead.No);
                ...
                ApprovalEntry4.SetRange("Document No.", impSurrHead.No);
                ...
                UserSetup.Reset();
                UserSetup.SetRange("User ID", impSurrHead.Cashier);
    ...
    var
      ...
      //  User1, User2, User3, User4 : Record "User Setup";
      //  Approval1, Approval2, approval3, Approval4 : record "Approval Entry";
        // sign1, sign2, sign3, sign4 : 
      //  Approve1, Approve2, Approve3, Approve4 : Code[50];
        Surheader: Record "FIN-Imprest Surr. Header";
