report 52178732 "Purchase Quote Report1"
{
    DefaultLayout = RDLC;
    UsageCategory = ReportsAndAnalysis;
    RDLCLayout = './Procurement/Reports/SSR/PurchaseQuoteRequestReport.rdl';
    ...
    dataset
    {
        dataitem(QVendors; "PROC-Quotation Request Vendors")
        {
            ...
            dataitem(PurchQuote; "PROC-Purchase Quote Header")
            {
                ...
                column(PostingDescription_PurchaseQuoteHeader; PurchQuote."Description")
                {
                }
