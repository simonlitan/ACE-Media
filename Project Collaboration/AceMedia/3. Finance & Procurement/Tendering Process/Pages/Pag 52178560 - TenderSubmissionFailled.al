page 52178560 "Tender Submission Failled"
{
    Caption = 'Disqualified Submissions';
    CardPageID = "Tender Tier Submission Header";
    Editable = false;
    PageType = ListPart;
    SourceTable = "Tender Submission Header";
    SourceTableView = where("Bid Status" = filter("Prelim Disqualif" | "Tech Disqualif" | "Demo Disqualif" | "Fin Disqualif"));
