report 52179121 "Individual Payslip(Horizontal)"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Payroll/Report/SSR/IndividualPayslipHorizontal.rdl';
    ...
    dataset
    {
        dataitem(DataItem6207; "PRL-Salary Card")
        {
            ...
            column(payPoint; 'Kasarani UNIVERSITY')
            {
            }
    ...
    var
        "PRL-Salary Card": record "PRL-Salary Card";
        bankst: Record "PRL-Bank Structure";
        datesfil: Text;
        dates1: Record Date;
        empNo1: Code[150];
        empNo2: Code[150];
