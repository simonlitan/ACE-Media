page 52178960 "ICT Role Center"
{
    ...
    actions
    {
        ...
        area(sections)
        {
            ...
            //         RunObject = Page "ICT Support Desk";
            //     }
            //     // action(AssignedRequests)
            //     // {
            //     //     Caption = 'Assigned Requests';
            //     //     ApplicationArea = All;
            //     //     Promoted = true;
            //     //     PromotedCategory = process;
            //     //     RunObject = Page "Assigned Support  List ";
            //     // }
            //     action(escalatedRequests)
            //     {
            //         Caption = 'Escalated request';
            //         ApplicationArea = All;
            //         Promoted = true;
            //         PromotedCategory = process;
            //         RunObject = Page "ICT Support Escalate List";
            //     }//"ICT Support Consultant List"
            //     action(ConsultedSupport)
            //     {
            //         Caption = 'Consulted request';
            //         ApplicationArea = All;
            //         Promoted = true;
            //         PromotedCategory = process;
            //         RunObject = Page "ICT Support Consultant List";
            //     }//"ICT Support Consultant List"
            //     action(PendingClose)
            //     {
            //         Caption = 'User Closure';
            //         Promoted = true;
            //         PromotedCategory = process;
            //         ApplicationArea = All;
            ...
            //     action(SupportSeries)
            //     {
            //         Caption = 'Support Setup';
            //         ApplicationArea = All;
            //         Promoted = true;
            //         PromotedCategory = Process;
            //         RunObject = Page "ICT No. Series";
            ...
            group("ICT Setups")
            {
                ...
                action("ICT Support Areas")
                {
                    ApplicationArea = All;
                    RunObject = page "ICT Support Areas";
                }
            }
