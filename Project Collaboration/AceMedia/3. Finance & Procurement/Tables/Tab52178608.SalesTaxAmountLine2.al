table 52178608 "Sales Tax Amount Line 2"
{
    ...
    fields
    {
        ...
        field(12; "Calculated Tax Amount"; Decimal)
        {
            AutoFormatType = 1;
            Caption = 'Calculated Tax Amount';
            Editable = false;
        }
        field(13; "Tax Difference"; Decimal)
        {
        ...
        field(15; "Tax Liable"; Boolean)
        {
            Caption = 'Tax Liable';
        }
        field(16; "Tax Area Code for Key"; Code[20])
        {
            Caption = 'Tax Area Code for Key';
            TableRelation = "Tax Area";
        }
        field(17; "Invoice Discount Amount"; Decimal)
        {
            AutoFormatType = 1;
            Caption = 'Invoice Discount Amount';
            Editable = false;
        }
        field(18; "Inv. Disc. Base Amount"; Decimal)
        {
            AutoFormatType = 1;
            Caption = 'Inv. Disc. Base Amount';
            Editable = false;
        }
        field(19; "Expense/Capitalize"; Boolean)
        {
            Caption = 'Expense/Capitalize';
        }
        field(20; "Print Order"; Integer)
        {
            Caption = 'Print Order';
        }
        field(21; "Print Description"; Text[30])
        {
            Caption = 'Print Description';
        }
        field(22; "Calculation Order"; Integer)
        {
            Caption = 'Calculation Order';
        }
        field(23; "Round Tax"; Option)
        {
            Caption = 'Round Tax';
            Editable = false;
        ...
        field(24; "Is Report-to Jurisdiction"; Boolean)
        {
        ...
        field(26; "Tax Base Amount FCY"; Decimal)
        {
