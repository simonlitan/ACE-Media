...
/// </summary>
report 52179085 "Employee Leave"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("HRM-Employee C"; "HRM-Employee C")
        {
            ...
            column(GlobalDimension1Code_HRMEmployeeC; "Global Dimension 1 Code")
            {
            }
            column(GlobalDimension2Code_HRMEmployeeC; "Global Dimension 2 Code")
            {
            }
