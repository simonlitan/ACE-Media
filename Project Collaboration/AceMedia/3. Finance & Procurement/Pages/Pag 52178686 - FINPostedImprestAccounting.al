page 52178686 "FIN-Posted Imprest Accounting"
{
        ...
        IF FINImprestSurrLines.FIND('-') THEN BEGIN
            ...
            BEGIN
                ...
                IF (FINImprestSurrLines.Amount > 0) THEN BEGIN
                    ...
                    FINImprestSurrLines.Amount, FINImprestSurrLines."Account Name", USERID, TODAY, 'IMPREST',
                     Rec."Imprest Issue Doc. No" + FINImprestSurrLines."Account No:" + '-' + Format(FINImprestSurrLines."Line No."), '');
                END;
            END;
