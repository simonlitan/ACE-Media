table 52179209 "PRL-Vital Setup Info"
{
    ...
    fields
    {
        ...
        field(44; "1st Overtime Code"; Code[10])
        {
            DataClassification = ToBeClassified;
            TableRelation = "PRL-Transaction Codes"."Transaction Code";
        }
        field(45; "Lost Hours Code"; Code[10])
        {
            DataClassification = ToBeClassified;
            TableRelation = "PRL-Transaction Codes"."Transaction Code";
        }
        field(46; "2nd Overtime Code"; Code[10])
        {
            DataClassification = ToBeClassified;
            TableRelation = "PRL-Transaction Codes"."Transaction Code";
        }
        field(47; "NSSF Employee"; Code[10])
        {
            //DataClassification = ToBeClassified;
            //TableRelation = "PRL-Transaction Codes"."Transaction Code";
        }
        field(48; "Apply NHIF Insurance Relief"; Boolean)
        {

        }
        field(49; "NHIF Insurance Relief Limit"; Decimal)
        {

        }
        field(50; "NHIF Insurance Relief %"; Decimal)
        {

        }
        field(51; "House Allowance Code"; Code[30])
        {
