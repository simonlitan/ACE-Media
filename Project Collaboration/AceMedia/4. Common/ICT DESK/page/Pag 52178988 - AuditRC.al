page 52178988 "Audit RC"
{
    // CurrPage."Help And Setup List".ShowFeatured;

    Caption = 'Audit Role Center', Comment = '{Dependency=Match,"ProfileDescription_SMALLBUSINESS"}';
    PageType = RoleCenter;
    ...
    layout
    {
        area(rolecenter)
        {
            ...
            part(Control48; "Team Member Activities No Msgs")
            {
                Visible = true;
                ApplicationArea = Suite;
                Caption = 'Auditor Profile';
            }
        ...
        area(reporting)
        {
            ...
            group("Procurement Reports")
            {
                ...
                action("Posted  Credit Memos")
                {
                    ...
                    ToolTip = 'Open the list of posted  credit memos.';
                }
