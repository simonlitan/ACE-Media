report 52179159 "Casual- Payslip (Horizontal)"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Payroll/Report/SSR/CasualPayslipHorizontal.rdl';

    dataset
    {
        dataitem("PRL Employee Days Worked"; "PRL Employee Days Worked")
        {
