page 52178690 "FIN-Staff Advance Accounting"
{
    PageType = Card;
        ...
        area(processing)
        {
            group(Functions)
            {
                ...
                action(EDMS)
                {
                    ...
                    begin
                        DMS.Reset;
                        DMS.SetRange("Document Type", DMS."Document Type"::"Imprest SURR");
                        if DMS.Find('-') then begin
                            Hyperlink(DMS."url path" + Rec."No");
                        end else
                            Message('No Link ' + format(DMS."Document Type"::"Imprest SURR"));
                    end;
                }
        ...
        IF BCSetup."Raise Document" = BCSetup."Raise Document"::"Raise Claim" THEN BEGIN
            ...
            IF Payline.FIND('-') THEN
                ...
                BEGIN
                    ...
                    ClaimsLines."Document No." := ClaimsHeader."No.";
        ...
        IF FINStaffAdvancSurrDetails.FIND('-') THEN BEGIN
            ...
            BEGIN
                ...
                IF (FINStaffAdvancSurrDetails.Amount > 0) THEN BEGIN
                    // Commit Budget Here
                    PostBudgetEnties.ExpenseBudget(FINStaffAdvancSurrDetails."Account No:", Rec."Surrender Date", Rec."Global Dimension 1 Code", Rec."Shortcut Dimension 2 Code",
                    FINStaffAdvancSurrDetails.Amount, FINStaffAdvancSurrDetails."Account Name", USERID, TODAY, 'ADVANCE',
                     Rec."Imprest Issue Doc. No" + FINStaffAdvancSurrDetails."Account No:" + '-' + Format(FINStaffAdvancSurrDetails."Line No."), '');
                END;
            END;
