table 52179151 "HRM-Applicants Shortlist"
{
    ...
    fields
    {
        ...
        field(2; "Stage Score"; Decimal)
        {
            Editable = false;
        }
        field(3; Qualified; Boolean)
        {
        }
        field(4; "Applicant Name"; Text[100])
        {
            Editable = false;
        }
        field(5; "ID No"; Text[100])
        {
            Editable = false;
        }
        ...
        field(8; "Manual Change"; Boolean)
        {
            Editable = false;
        }
        field(9; Employ; Boolean)
        {
        ...
        field(12; "Reporting Date"; Date)
        {
        }
        field(13; "Shortlisting Officer"; Code[30])
        {
            TableRelation = "User Setup"."User ID";
        }
        field(14; "Job Applied for"; Text[100])
        {
        }
        ...
        field(18; "Employee Requisition No"; Code[10])
        {
        }
        field(19; "Shortlist Officer Count"; Integer)
        {
