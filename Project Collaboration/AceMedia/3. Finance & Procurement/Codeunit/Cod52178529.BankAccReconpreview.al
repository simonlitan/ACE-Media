codeunit 52178529 "Bank Acc Recon preview"
{
    ...
    procedure Preview(var Subscriber: Codeunit "bank recon post"; var BankAccReconciliationSource: Record "Bank Acc. Reconciliation")
    begin
    ...
    [CommitBehavior(CommitBehavior::Ignore)]
    local procedure PreviewStart(var Subscriber: Codeunit "bank recon post"; var BankAccReconciliationSource: Record "Bank Acc. Reconciliation")
    var
    ...
    local procedure RunPreview(var Subscriber: Codeunit "bank recon post"; var BankAccReconciliationSource: Record "Bank Acc. Reconciliation"): Boolean
    var
        Result: Boolean;
    begin
    ...
    procedure SetContext(var Subscriber: Codeunit "bank recon post"; var BankAccReconciliationSource: Record "Bank Acc. Reconciliation")
    begin
    ...
    local procedure OnBeforeRunPreview(var Subscriber: Codeunit "bank recon post"; var BankAccReconciliationSource: Record "Bank Acc. Reconciliation")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnRunPreview(var Result: Boolean; var Subscriber: Codeunit "bank recon post"; var BankAccReconciliationSource: Record "Bank Acc. Reconciliation")
    begin
    end;
