table 52178547 "Advance PettyCash Header"
{
    ...
    fields
    {
        ...
        field(10; "Paying Bank Account"; Code[20])
        {
        ...
        field(11; "Global Dimension 1 Code"; Code[30])
        {
            CaptionClass = '1,1,1';
        ...
        field(13; "Global Dimension 2 Code"; Code[30])
        {
            CaptionClass = '1,1,2';
        ...
        field(18; "Payment Release Date"; Date)
        {
        ...
        field(20; "Responsibility Center"; Code[50])
        {
        ...
        field(23; "Surrender Status"; Option)
        {
            OptionMembers = " ",Full,Partial;
        }
        field(24; Purpose; Text[250])
        {
        }
        field(25; "On behalf of"; text[100])
        {

        }
        Field(26; "Shortcut Dimension 3"; code[20])
        {
            CaptionClass = '1,2,3';
        ...
        IF PettyCashLine.FIND('-') THEN BEGIN
            ...
            BEGIN
                ...
                IF (PettyCashLine.Amount > 0) THEN BEGIN
                    // Commit Budget Here
                    PostBudgetEnties.ExpenseBudget(PettyCashLine."Account No.", Rec.Date, Rec."Global Dimension 1 Code", Rec."Global Dimension 2 Code",
    ...
    begin
        ...
        IF PettyCashLine.FIND('-') THEN BEGIN
            ...
            BEGIN
                ...
                IF (PettyCashLine.Amount > 0) THEN BEGIN
                    // Commit Budget Here
                    PostBudgetEnties.CancelBudgetCommitment(PettyCashLine."Account No.", Rec.Date, Rec."Global Dimension 1 Code", Rec."Global Dimension 2 Code",
                    Rec."Shortcut Dimension 3", PettyCashLine.Amount, PettyCashLine."Account Name", USERID, 'ADVPETTY',
                    Rec."No." + PettyCashLine."Account No." + '-' + Format(PettyCashLine."Line No."), Rec.Payee);
                END;
            END;
            UNTIL PettyCashLine.NEXT = 0;
        END;
    ...
    begin
        ...
        if Payments.Find('-') then begin
            ...
            if PettyCashLine.Find('-') then begin
                ...
                GenJnlLine."Shortcut Dimension 5" := Payments."Shortcut Dimension 3";
    ...
    begin
        ...
        if Payments.Find('-') then begin
            ...
            if PettyCashLine.Find('-') then begin
                ...
                SurrHeader."Shortcut Dimension 3" := rec."Shortcut Dimension 3";
