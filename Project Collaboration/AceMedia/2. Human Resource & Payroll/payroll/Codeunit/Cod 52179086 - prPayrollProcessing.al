codeunit 52179086 "prPayrollProcessing"
{
    ...
    var
        ...
        prPayrollCode: code[50];
        secondaryPay: Boolean;
        P9NSSF1: decimal;
        P9NSSF2: Decimal;
        ...
        gPensionPer: Decimal;
        gPensionAmount: decimal;
        EmpPensionContrib: Decimal;
        empTr: Record "PRL-Employee Transactions";
        empPeriod: Record "PRL-Payroll Periods";
        sarr: Decimal;
    ...
    var
        ...
        HlevyRelief: Decimal;
        curGrossPay: Decimal;
        CurAllowableGpay: Decimal;
        curTotAllowances: Decimal;
        curTotAllAllowances: Decimal;
        ...
        CurAllowableAmount: Decimal;
        TotalAllowableAmount: Decimal;
    begin
        HrEmployee.RESET;
        HrEmployee.SETRANGE(HrEmployee."No.", strEmpCode);
        IF HrEmployee.FIND('-') THEN BEGIN
            secondaryPay := HrEmployee."Secondary Income";
        ...
        begin
            ...
            TSubGroupOrder, strTransDescription, curTransAmount, 0, intMonth, intYear, Membership, prEmployeeTransactions."Reference No", SelectedPeriod, Dept,
            ...
            if prEmployeeTransactions.Find('-') then begin
                ...
                repeat
                    ...
                    if prTransactionCodes.Find('-') then begin
                        ...
                        if prTransactionCodes."Is Formula" then begin
                            ...
                            IF prTransactionCodes."Is a Rate" THEN BEGIN
                                ...
                                //     curTransAmount := ROUND(curTransAmount * GetBasicAndOtherAllowasupnces(strEmpCode, intMonth, intYear, SumItems::Basic))
                                // ELSE
                        ...
                        if (prTransactionCodes."Is Formula") and (prTransactionCodes."Is Leave") then begin

                            strExtractedFrml := fnPureFormula(strEmpCode, intMonth, intYear, prTransactionCodes.Formula);
                            curTransAmount := Round(fnFormulaResult(strExtractedFrml));
                            curTransAmount := ROUND(curTransAmount);
                            if curTransAmount > 50000 then begin

                                curTransAmount := 50000
                            end;
                        end
                        else begin
                            curTransAmount := prEmployeeTransactions.Amount;
                        ...
                        Clear(LeaveAllowance);
                        LeaveAllowance := curTransAmount;
                    ...
                    prTransactionCodes.SetRange(prTransactionCodes."Transaction Code", prEmployeeTransactions."Transaction Code");
                    prTransactionCodes.SetRange(prTransactionCodes."Transaction Type", prTransactionCodes."Transaction Type"::Income);
                    prTransactionCodes.SetRange(prTransactionCodes.Allowable, false);
                    prTransactionCodes.SetRange(prTransactionCodes."Special Transactions", prTransactionCodes."Special Transactions"::Ignore);
                    if prTransactionCodes.Find('-') then begin
                        CurAllowableAmount := 0;
                        ...
                        if prTransactionCodes."Is Formula" then begin
                            strExtractedFrml := fnPureFormula(strEmpCode, intMonth, intYear, prTransactionCodes.Formula);
                            CurAllowableAmount := Round(fnFormulaResult(strExtractedFrml)); //Get the calculated amount
                            ...
                            IF prTransactionCodes."Is a Rate" THEN BEGIN
                                ...
                                //  CurAllowableAmount := CurAllowableAmount * prEmployeeTransactions."Rate Factor";
                                IF prTransactionCodes."Is Rate of" = prTransactionCodes."Is Rate of"::"Basic Pay" THEN
                                    CurAllowableAmount := ROUND((GetBasicAndOtherAllowances(strEmpCode, intMonth, intYear, SumItems::Basic)) * (12 / 365) * prEmployeeTransactions."Rate Factor")
                                ELSE
                                    IF prTransactionCodes."Is Rate of" = prTransactionCodes."Is Rate of"::"Basic & House Allowance" THEN
                                        CurAllowableAmount := ROUND(GetBasicAndOtherAllowances(strEmpCode, intMonth, intYear, SumItems::"Basic & House") * (12 / 365) * prEmployeeTransactions."Rate Factor");
                                prEmployeeTransactions.Amount := CurAllowableAmount;

                                prEmployeeTransactions.MODIFY;
                            END;
                            CurAllowableAmount := ROUND(CurAllowableAmount);
                        end
                        else begin
                            CurAllowableAmount := prEmployeeTransactions.Amount;
                        end;
                        ...
                        if (prTransactionCodes."Is Formula") and (prTransactionCodes."Is Leave") then begin
                            ...
                            strExtractedFrml := fnPureFormula(strEmpCode, intMonth, intYear, prTransactionCodes.Formula);
                            CurAllowableAmount := Round(fnFormulaResult(strExtractedFrml));
                            CurAllowableAmount := ROUND(CurAllowableAmount);
                            if CurAllowableAmount > 50000 then begin

                                CurAllowableAmount := 50000
                            end;
                        end
                        else begin
                            CurAllowableAmount := prEmployeeTransactions.Amount;
                        ...
                        if (not prTransactionCodes.Taxable) and (prTransactionCodes."Special Transactions" =
                        prTransactionCodes."Special Transactions"::Ignore) then
                            curNonTaxable := curNonTaxable + CurAllowableAmount;
                        ...
                        curTotAllAllowances := curTotAllAllowances + CurAllowableAmount; //Sum-up all the allowances
                                                                                         //CurAllowableAmount := CurAllowableAmount;




                    end;
                //end Allowable Earning
            ...
            fnUpdatePeriodTrans(strEmpCode, 'GPAY', TGroup, TGroupOrder, TSubGroupOrder, strTransDescription, curTransAmount, 0, intMonth,
             intYear, '', prEmployeeTransactions."Reference No", SelectedPeriod, Dept, '', JournalPostAs::" ", JournalPostingType::" ", '', CoopParameters::none);

            //Allowable Gross pay
            CurAllowableGpay := (curBasicPay + curTotAllAllowances); //Litan


            fnUpdatePeriodTrans(strEmpCode, 'AGPAY', 'AGPAY', 4, 1, 'Gross Allowable Pay', CurAllowableGpay, 0, intMonth,
             intYear, '', prEmployeeTransactions."Reference No", SelectedPeriod, Dept, '', JournalPostAs::" ", JournalPostingType::" ", '', CoopParameters::none);
            PRLSalaryCard.Reset();
            PRLSalaryCard.setrange("Employee Code", strEmpCode);
            PRLSalaryCard.setrange(Shif, True);
            If PRLSalaryCard.find('-') Then Begin
                //Curshif := GetShif(curGrossPay);
                Curshif := GetShif(CurAllowableGpay);
                curTransAmount := Curshif;
                strTransDescription := 'SHIF';
                TGroup := 'STATUTORIES';
                TGroupOrder := 7;
                TSubGroupOrder := 2;
                fnUpdatePeriodTrans(strEmpCode, 'SHIF', TGroup, TGroupOrder, TSubGroupOrder, strTransDescription, curTransAmount, 0, intMonth, intYear, '', prPeriodTransactions."Reference No", SelectedPeriod, Dept, '', JournalPostAs::" ", JournalPostingType::" ", '', CoopParameters::none);



                // end;

                //Housing levy and arears
                fnUpdatePeriodTrans(strEmpCode, 'HE-Levi', 'HE-Levi', 16, 0, 'Housing Levi Contrib Employer', CurAllowableGpay * 0.015, 0, intMonth, intYear, '', prPeriodTransactions."Reference No", SelectedPeriod, Dept, '5000069', JournalPostAs::" ", JournalPostingType::" ", '', CoopParameters::none);

                // empTr.Reset();
                // empTr.SetRange("Employee Code", strEmpCode);
                // empTr.SetRange("Payroll Period", SelectedPeriod);
                // empTr.SetFilter("Transaction Code", '%1|%2|%3', 'D-041', 'D-042', 'D-043');
                // //empTr.SetFilter("Transaction Code", '%1|%2|%3', 'D-041', 'D-042');
                // //Clear(HousingLevy);
                // //  HousingLevy := ((curBasicPay + curTotAllowances + curSalaryArrears) - (curBasicPay * 0.3)) * 0.015;
                // if empTr.Find() then begin
                //     // clear(SubGroupCount);
                //     repeat
                //         SubGroupCount += 1;
                //         fnUpdatePeriodTrans(strEmpCode, empTr."Transaction Code", CopyStr(empTr."Transaction Name", 1), 16, SubGroupCount, 'Housing Levi Contrib Employer', CurAllowableGpay * 0.015 + empTr.Amount, 0, intMonth,
                //         intYear, '', prPeriodTransactions."Reference No", SelectedPeriod, Dept, '5000069', JournalPostAs::" ", JournalPostingType::" ", '', CoopParameters::none);


                //     until empTr.Next() = 0;
                //     // HousingLevy := ((curBasicPay + curTotAllowances + curSalaryArrears) - (curGrossPay*0.3))* 0.015;
                // end else begin
                //     fnUpdatePeriodTrans(strEmpCode, empTr."Transaction Code", empTr."Transaction Name", 16, 0, 'Housing Levi Contrib Employer', CurAllowableGpay * 0.015 + empTr.Amount, 0, intMonth,
                //  intYear, '', prPeriodTransactions."Reference No", SelectedPeriod, Dept, '5000069', JournalPostAs::" ", JournalPostingType::" ", '', CoopParameters::none);
                ...
                HREmp2.SetRange("Earns Gratuity", true);
                HREmp2.SetRange("On Probation", false);
                if HREmp2.Find('-') then begin
                    empPeriod.Reset();
                    empPeriod.SetRange(Closed, false);
                    if empPeriod.Find('-') then begin
                        empTr.Reset();
                        empTr.SetRange("Employee Code", strEmpCode);
                        empTr.SetRange("Payroll Period", SelectedPeriod);
                        empTr.SetFilter("Transaction Code", '%1', 'E-010');
                        if empTr.Find('-') then begin
                            ...
                            HREmp2.SetRange("No.", strEmpCode);
                            HREmp2.SetRange("Earns Gratuity", true);
                            //HREmp2.SetFilter("Salary Grade", '%1|%2|%3', 'PCF1', 'PCF2', 'PCF3');
                            IF HREmp2.Find('-') then begin
                                if ((HREmp2."Gratuity Wth Voluntary Pension") and (HREmp2."Employee Pension %" <> 0)) then begin
                                    gPensionPer := HREmp2."Employee Pension %" / 100;
                                    gratuityAmount := (curBasicPay + sarr) * (0.31 - (0.2 - gPensionPer));
                                    //Gratuity Modification
                                    fnUpdatePeriodTrans(strEmpCode, 'GRATUITY', 'EMPLOYER CONTRIBUTIONS', 13, 0, 'Gratuity Employer Contribution', gratuityAmount, 0, intMonth, intYear, '', prEmployeeTransactions."Reference No", SelectedPeriod, Dept, '', JournalPostAs::" ", JournalPostingType::" ", '', CoopParameters::none);

                                    gPensionAmount := (curBasicPay + sarr) * (0.2 - gPensionPer);
                                    //Employer pension Contribution with gratuity
                                    fnUpdatePeriodTrans(strEmpCode, 'GEmprPension', 'GEmprPension', 13, 0, 'Gratuity Contribution', gPensionAmount, 0, intMonth, intYear, '', prEmployeeTransactions."Reference No", SelectedPeriod, Dept, '', JournalPostAs::" ", JournalPostingType::" ", '', CoopParameters::none);

                                end else begin
                                    gratuityAmount := (curBasicPay + sarr) * 0.31;
                                    //Gratuity Modification
                                    fnUpdatePeriodTrans(strEmpCode, 'GRATUITY', 'EMPLOYER CONTRIBUTIONS', 13, 0, 'Gratuity Employer Contribution', gratuityAmount, 0, intMonth, intYear, '', prEmployeeTransactions."Reference No", SelectedPeriod, Dept, '', JournalPostAs::" ", JournalPostingType::" ", '', CoopParameters::none);
                                end;
                            end;
                            ...
                            IF HREmp2.Find('-') then begin
                                if ((HREmp2."Gratuity Wth Voluntary Pension") and (HREmp2."Employee Pension %" <> 0)) then begin
                                    gPensionPer := HREmp2."Employee Pension %" / 100;
                                    gratuityAmount := curBasicPay * (0.31 - (0.2 - gPensionPer));
                                    //Gratuity Modification
                                    fnUpdatePeriodTrans(strEmpCode, 'GRATUITY', 'EMPLOYER CONTRIBUTIONS', 13, 0, 'Gratuity Employer Contribution', gratuityAmount, 0, intMonth, intYear, '', prEmployeeTransactions."Reference No", SelectedPeriod, Dept, '', JournalPostAs::" ", JournalPostingType::" ", '', CoopParameters::none);
                                    gPensionAmount := curBasicPay * (0.2 - gPensionPer);
                                    //Employer pension Contribution with gratuity
                                    fnUpdatePeriodTrans(strEmpCode, 'GEmprPension', 'GEmprPension', 13, 0, 'Gratuity Contribution', gPensionAmount, 0, intMonth, intYear, '', prEmployeeTransactions."Reference No", SelectedPeriod, Dept, '', JournalPostAs::" ", JournalPostingType::" ", '', CoopParameters::none);
                                end
                                else begin
                                    gratuityAmount := curBasicPay * 0.31;
                                    //Gratuity Modification
                                    fnUpdatePeriodTrans(strEmpCode, 'GRATUITY', 'EMPLOYER CONTRIBUTIONS', 13, 0, 'Gratuity Employer Contribution', gratuityAmount, 0, intMonth, intYear, '', prEmployeeTransactions."Reference No", SelectedPeriod, Dept, '', JournalPostAs::" ", JournalPostingType::" ", '', CoopParameters::none);
                                end;
                            end;
                ...
                HREmp2.Reset();
                HREmp2.SetRange("No.", strEmpCode);
                HREmp2.SetRange("Earns Gratuity", false);
                HREmp2.SetRange("On Probation", false);
                if HREmp2.Find('-') then begin
                    empPeriod.Reset();
                    empPeriod.SetRange(Closed, false);
                    if empPeriod.Find('-') then begin
                        ...
                        empTr.Reset();
                        empTr.SetRange("Employee Code", HREmp2."No.");

                        empTr.SetRange("Payroll Period", empPeriod."Date Opened");
                        empTr.SetFilter("Transaction Code", '%1', 'E-010');
                ...
                /*  HREmp2.Reset();
                 ...
                 if HREmp2.Find('-') then begin
                     ...
                     if empPeriod.Find('-') then begin
                         ...
                         empTr.SetRange("Employee Code", HREmp2."No.");
                         empTr.SetRange("Payroll Period", empPeriod."Date Opened");
                         //empTr.SetFilter("Transaction Code", '%1', 'E-011');
                         if empTr.Find('-') then begin
                             Clear(sarr);
                             sarr := empTr.Amount;
                             EmpPensionContrib := ((curBasicPay + sarr) * (0.2));
                ...
                IF blnPaysNssf THEN begin
                    ...
                    //TGroupOrder := 6;
                    TSubGroupOrder := 1;
                    fnUpdatePeriodTrans(strEmpCode, 'NSSFI', TGroup, TGroupOrder, TSubGroupOrder, strTransDescription, curTransAmount, 0, intMonth, intYear, '', prEmployeeTransactions."Reference No", SelectedPeriod, Dept, NSSFEMPyee, JournalPostAs::Credit, JournalPostingType::"G/L Account", '', CoopParameters::NSSF);
                    ...
                    // TGroupOrder := 6;
                    TSubGroupOrder := 1;
                    fnUpdatePeriodTrans(strEmpCode, 'NSSFII', TGroup, TGroupOrder, TSubGroupOrder, strTransDescription, curTransAmount, 0, intMonth, intYear, '', prEmployeeTransactions."Reference No", SelectedPeriod, Dept, NSSFEMPyee, JournalPostAs::Credit, JournalPostingType::"G/L Account", '', CoopParameters::NSSF);
                    //NSSF EMPLOYER
                    curNSSF := fnGetEmployeeNSSFTierI(curGrossPay) + fnGetEmployeeNSSFTierII(curGrossPay);
                    curTransAmount := curNSSF;
                    fnUpdatePeriodTrans(strEmpCode, 'NSSF EMPLOYER', 'EMPLOYER CONTRIBUTIONS', 13, 0, 'Nssf Employer Contribution', curTransAmount, 0, intMonth, intYear, '', prEmployeeTransactions."Reference No", SelectedPeriod, Dept, '', JournalPostAs::" ", JournalPostingType::" ", '', CoopParameters::none);
                end;
                if blnPaysNssf then begin
                    ...
                    curNSSF := fnGetEmployeeNSSFTierI(curGrossPay);
                    curTransAmount := curNSSF;
                    fnUpdateEmployerDeductions(strEmpCode, 'NSSFI', 'EMP', TGroupOrder, TSubGroupOrder, '', curTransAmount, 0, intMonth, intYear, prEmployeeTransactions.Membership, prEmployeeTransactions."Reference No", SelectedPeriod);
                    curNSSF := fnGetEmployeeNSSFTierII(curGrossPay);
                    curTransAmount := curNSSF;
                    fnUpdateEmployerDeductions(strEmpCode, 'NSSFII', 'EMP', TGroupOrder, TSubGroupOrder, '', curTransAmount, 0, intMonth, intYear, prEmployeeTransactions.Membership, prEmployeeTransactions."Reference No", SelectedPeriod);
                    ...
                    strTransDescription := 'NSSF(I)'; //change Defined contributions to NSSF-hosea
                    TGroup := 'TAXATION';
                    TGroupOrder := 6;
                    TSubGroupOrder := 1; //CHANGE tax calculations TO APYE INFORMATION-HOSEA // change TGroupOrder :=6 to 7
                    fnUpdatePeriodTrans(strEmpCode, 'DEFCON1', TGroup, TGroupOrder, TSubGroupOrder, strTransDescription, curTransAmount, 0, intMonth, intYear, '', prEmployeeTransactions."Reference No", SelectedPeriod, Dept, '', JournalPostAs::" ", JournalPostingType::" ", '', CoopParameters::none);
                    ...
                    TGroupOrder := 6;
                    TSubGroupOrder := 1; //CHANGE tax calculations TO APYE INFORMATION-HOSEA // change TGroupOrder :=6 to 7
                    fnUpdatePeriodTrans(strEmpCode, 'DEFCON2', TGroup, TGroupOrder, TSubGroupOrder, strTransDescription, curTransAmount, 0, intMonth, intYear, '', prEmployeeTransactions."Reference No", SelectedPeriod, Dept, '', JournalPostAs::" ", JournalPostingType::" ", '', CoopParameters::none);
                    //fnUpdatePeriodTrans(strEmpCode, 'NITA', 'EMPLOYER CONTRIBUTIONS', 13, 0, 'Nita Employer Contributions', 50, 0, intMonth, intYear, '', '', SelectedPeriod, Dept, '', JournalPostAs::" ", JournalPostingType::" ", '', CoopParameters::none);
                end;
                ...
                //Update Employer deductions//jeff
                /*  if blnPaysNssf then
                     curNSSF := curNssfEmployee;//fnGetEmployerNSSF(curNssf_Base_Amount);
                 curTransAmount := curNSSF;
                ...
                if (blnGetsPAYERelief) then begin
                    // Modified to avoid giving relieve to secondary income earners
                    IF HrEmployee.FIND('-') THEN BEGIN
                        secondaryPay := HrEmployee."Secondary Income";
                        IF NOT secondaryPay THEN BEGIN
                            ...
                            fnUpdatePeriodTrans(strEmpCode, 'PSNR', TGroup, TGroupOrder, TSubGroupOrder, strTransDescription,
                             curTransAmount, 0, intMonth, intYear, '', prEmployeeTransactions."Reference No", SelectedPeriod, Dept, '', JournalPostAs::" ", JournalPostingType::" ", '',
                             CoopParameters::none);
                        end
                        else
                            curReliefPersonal := 0;
               ...
               SpecialTransType::"Defined Contribution", FALSE);//Self contrib Pension is 1 on [Special Transaction]
                ...
                if blnPaysPaye and blnGetsPAYERelief then begin
                    ...
                    if (curInsuranceReliefAmount > 0) and (blnInsuranceCertificate) then begin
                        ...
                        //Message(strEmpCode + Format(curMaximumRelief));
                        //Added Hosea - To Cap Insurance Relief to Setup amount
                        ...
                        curTransAmount, 0, intMonth, intYear, '', prEmployeeTransactions."Reference No", SelectedPeriod, Dept,
                        '', JournalPostAs::Credit, JournalPostingType::" ", '', CoopParameters::none);
                    end;
                    //********************************************************************************************************************************************************
                    //Get housing Relief
                    //Exclude Housing Relief arrears from GPAY

                    //HlevyRelief := (curGrossPay * 0.015) * 0.15; //Insurance is 3 on [Special Transaction]
                    //HlevyRelief := (CurAllowableGpay * 0.015) * 0.15;

                    //********************************************************************************************************************************************************

                    // curTransAmount := (HlevyRelief);
                    // strTransDescription := 'Housing Levy Relief';
                    // TGroup := 'TAXATION';
                    // TGroupOrder := 6;
                    // TSubGroupOrder := 8;   //CHANGE tax calculations TO PAYE INFORMATION -HOSEA // change TGroupOrder :=6 to 7
                    // fnUpdatePeriodTrans(strEmpCode, 'HSLR', TGroup, TGroupOrder, TSubGroupOrder, strTransDescription,
                    // curTransAmount, 0, intMonth, intYear, '', prEmployeeTransactions."Reference No", SelectedPeriod, Dept,
                    // '', JournalPostAs::Credit, JournalPostingType::" ", '', CoopParameters::none);
                   ...
                   SpecialTransType::Morgage, false);
                    ...
                    if curNonTaxable > 0 then begin
                        ...
                        curNonTaxable, 0, intMonth, intYear, '', prEmployeeTransactions."Reference No", SelectedPeriod, Dept, '', JournalPostAs::" ", JournalPostingType::" ", '',
                        CoopParameters::none);
                    end;
                ...
                if PRTransCode_2.Find('-') then begin
                    ...
                    if PREmpTrans_2.Find('-') then begin
                        ...
                        strTransDescription, curTransAmount, 0, intMonth, intYear, '', prEmployeeTransactions."Reference No", SelectedPeriod, Dept,
                        '', JournalPostAs::Credit, JournalPostingType::" ", '', CoopParameters::none);
                ...
                IF blnPaysNhif THEN BEGIN
                  //  curNHIF := fnGetEmployeeNHIF(curNhif_Base_Amount);
                    ...
                    //HIFReliefAmount := 0;
                    IF blnPaysPaye and blnPaysNhif THEN BEGIN
                        ...
                        IF ((NhifInsuApplies) AND (NHIFInsurancePercentage > 0)) THEN BEGIN
                           ...
                           // curNHIFInsuranceReliefAmount := ((NHIFInsurancePercentage / 100) * curNHIF);
                            ...
                            //     strTransDescription := 'N.H.I.F Insurance Relief';
                            //     TGroup := 'TAXATION';
                            //     TGroupOrder := 6;
                            //     TSubGroupOrder := 12;
                ...
                if (curPensionStaff + curDefinedContrib) > curMaxPensionContrib then
                    ...
                    curTaxablePay := curGrossTaxable - (curSalaryArrears + curDefinedContrib + curPensionStaff + curOOI + curHOSP + curNonTaxable + CurSHIF + (curGrossPay * 0.015)) + BenifitAmount;
                ...
                if (curReliefPersonal + curInsuranceReliefAmount) > curMaximumRelief then begin
                    ...
                    if (blnInsuranceCertificate) then begin
                        // HlevyRelief := 0.00225 * curGrossPay;
                        curPAYE := curTaxCharged - (curReliefPersonal + curInsuranceReliefAmount + curReliefMorgage + fNHIFReliefAmount);
                    end else begin
               ...
               curPAYE := curTaxCharged - (curReliefPersonal + curInsuranceReliefAmount);
                ...
                fnUpdatePeriodTrans(strEmpCode, 'PAYE', TGroup, TGroupOrder, TSubGroupOrder, strTransDescription,
                 curTransAmount, 0, intMonth, intYear, '', prEmployeeTransactions."Reference No", SelectedPeriod, Dept, TaxAccount, JournalPostAs::Credit,
                ...
                if prEmployeeTransactions.Find('-') then begin
                    ...
                    repeat
                        ...
                        prTransactionCodes.SetRange(prTransactionCodes."Mortgage interest", false);
                        if prTransactionCodes.Find('-') then begin
                            curTransAmount := 0;
                            curTransBalance := 0;
                            strTransDescription := '';
                            ...
                            //**************************If "deduct Premium" is not ticked and the type is mortgage- Dennis*****
                            //if (prTransactionCodes."Special Transactions" = prTransactionCodes."Special Transactions"::"Staff Loan")
                            // and (prTransactionCodes."Deduct Premium" = false) then begin
                            // curTransAmount := 0;
                            // end;
                            //
                ...
                curNetPay := curGrossPay - (curDefinedContrib + CurSHIF + curPAYE + curPayeArrears + curTotalDeductions + IsCashBenefit);
    ...
    /// <summary>
    /// fnGetEmployeeNSSFTierI.
    /// </summary>
    /// <param name="curBaseAmount">Decimal.</param>
    /// <returns>Return variable NSSF of type Decimal.</returns>
    procedure fnGetEmployeeNSSFTierI(curBaseAmount: Decimal) NSSF: Decimal
    var
        prNSSF: Record "PRL-NSSF";
        nssfAmount: Decimal;
        NssT1: Decimal;
    begin
        prNSSF.Reset;
            ...
            repeat
                if ((curBaseAmount >= prNSSF."Lower Limit") and (curBaseAmount <= prNSSF."Upper Limit")) then
                    if prNSSF."Amount Type" = prNSSF."Amount Type"::"Amount As Percentage" then begin
                        if prNSSF.Amount <> 0 then nssfAmount := Round((prNSSF.Amount / 100) * curBaseAmount, 1);
    ...
    procedure fnGetEmployeeNSSFTierII(curBaseAmount: Decimal) NSSF: Decimal
    var
        prNSSF: Record "PRL-NSSF";
        nssfAmount: Decimal;
        NssT1: Decimal;
                    ...
                    begin
                        ...
                        if (prEmployeeTransactions."Transaction Code" <> 'D066') then
                            if (prEmployeeTransactions."Transaction Code" <> 'P021') then begin
                                ...
                                prEmployeeTrans."Reference No" := prEmployeeTrans."Reference No" - 1;
            ...
            repeat
                        ...
                        case prPeriodTransactions."Group Order" of
                            ...
                            6: //Taxation
                                begin
                                    ...
                                    if prPeriodTransactions."Sub Group Order" = 2 then p9pension := prPeriodTransactions.Amount;
                                end;
                            7: //Statutories
                                begin
                                    if prPeriodTransactions."Sub Group Order" = 1 then begin
                                        if (prPeriodTransactions."Sub Group Order" = 1) and (prPeriodTransactions."Transaction Code" = 'NSSFI') then
                                            P9NSSF1 := prPeriodTransactions.Amount;
                                        if (prPeriodTransactions."Sub Group Order" = 1) and (prPeriodTransactions."Transaction Code" = 'NSSFII') then
                                            P9NSSF2 := prPeriodTransactions.Amount;
                                        P9NSSF := P9NSSF1 + P9NSSF2;
                                    end;
                            ...
                            9: //NetPay
                                begin
                                    ...
                                    prPayrollCode := prPeriodTransactions."Payroll Code";
                                end;
                        end;
                ...
                if P9NetPay <> 0 then
                    fnUpdateP9Table(prEmployee."No.", P9BasicPay, P9Allowances, P9Benefits, P9ValueOfQuarters, P9DefinedContribution,
                        ...
                        P9NHIF, p9pension, P9Deductions, P9NetPay, dtCurPeriod, PayrollCode);
    ...
    procedure fnUpdateEmployerDeductions(EmpCode: Code[20]; TCode: Code[20]; TGroup: Code[20]; GroupOrder: Integer; SubGroupOrder: Integer; Description: Text[50]; curAmount: Decimal; curBalance: Decimal; Month: Integer; Year: Integer; mMembership: Text[30]; ReferenceNo: Integer; dtOpenPeriod: Date)
    var
        prEmployerDeductions: Record "PRL-Employer Deductions";
    begin
    ...
    procedure GetGPAYandStatutories(CurGross: Decimal; HousingLevy: Decimal; curNSSF: Decimal) GetGpayStaturies: Decimal
    begin
        GetGpayStaturies := CurGross + HousingLevy + curNSSF;
    end;
    ...
    procedure GetShif(CurAllowableGpay: Decimal) GetShif: Decimal
    begin
        GetShif := CurAllowableGpay * 0.0275;
    end;
