/// <summary>
/// Page FIN-Staff Advance Req. (ID 52523).
/// </summary>
page 52178620 "FIN-Staff Advance Req.1"
{
    ...
    begin
        ...
        */
        ...
        Staffadvlines.reset();
        Staffadvlines.setrange("Document No.", rec."No.");
        ...
        IF FINStaffAdvanceLines.FIND('-') THEN BEGIN
            REPEAT BEGIN
                ...
                IF (FINStaffAdvanceLines.Amount > 0) THEN BEGIN
                    // Commit Budget Here
                    PostBudgetEnties.ExpenseBudget(FINStaffAdvanceLines."Account No.", Rec.Date, Rec."Global Dimension 1 Code",
                    Rec."Shortcut Dimension 2 Code", FINStaffAdvanceLines.Amount,
                     FINStaffAdvanceLines."Account Name", USERID, TODAY, 'ADVANCE',
    ...
    begin
        ...
        IF FINStaffAdvanceLines.FIND('-') THEN BEGIN
            REPEAT BEGIN
                ...
                IF (FINStaffAdvanceLines.Amount > 0) THEN BEGIN
                    // Commit Budget Here
                    PostBudgetEnties.CancelBudgetCommitment(FINStaffAdvanceLines."Account No.", Rec.Date, Rec."Global Dimension 1 Code", Rec."Shortcut Dimension 2 Code",
                 Rec."Shortcut Dimension 3 Code", FINStaffAdvanceLines.Amount, FINStaffAdvanceLines."Account Name", USERID, 'ADVANCE',
                 Rec."No." + FINStaffAdvanceLines."Account No." + '-' + Format(FINStaffAdvanceLines."Line No."), Rec.Purpose);
                END;
            END;
            UNTIL FINStaffAdvanceLines.NEXT = 0;
