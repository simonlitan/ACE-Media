table 52178568 "FIN-Payment Line"
{
    ...
    fields
    {
                    ...
                    CASE "Account Type" OF
                        ...
                        "Account Type"::Vendor:
                            BEGIN
                                ...
                                PH.Payee := Vend.Name;
                                PH."PIN  NO" := Vend."VAT Registration No.";
        ...
        field(20; Amount; Decimal)
        {
            ...
            begin
                ...
                //"Budgeted Allocation1" := 0;


                CalculateTax();
                 SetAmount2(rec);
                // if "Applies-to Doc. No." = '' then
                //     Amount2 := Amount else begin
                //     if "Applies-to Doc. No." <> '' then
                //         Amount2 := 0;
                // end;
        ...
        field(70; "Payment Reference"; Option)
        {
            OptionMembers = Normal,"Farmer Purchase";
        }
        field(71; "ID Number"; Code[8])
        {
        }
        field(72; "VAT Rate"; Decimal)
        {
        ...
        field(73; "Amount With VAT"; Decimal)
        {
        }
        field(74; "Currency Code"; Code[20])
        {
        }
        field(75; "Exchange Rate"; Decimal)
        {
        }
        field(76; "Currency Reciprical"; Decimal)
        {
        }
        field(77; "VAT Prod. Posting Group"; Code[20])
        {
            TableRelation = IF ("Account Type" = CONST("G/L Account")) "VAT Product Posting Group".Code;
        }
        field(78; "Budgetary Control A/C"; Boolean)
        {
            Editable = false;
        }
        ...
        field(83; "NetAmount LCY"; Decimal)
        {
        }
        field(84; "Applies-to Doc. Type"; Option)
        {
            Caption = 'Applies-to Doc. Type';
            OptionCaption = ' ,Payment,Invoice,Credit Memo,Finance Charge Memo,Reminder,Refund';
            OptionMembers = " ",Payment,Invoice,"Credit Memo","Finance Charge Memo",Reminder,Refund;
        }
        field(85; "Applies-to Doc. No."; Code[20])
        {
        ...
        field(86; "Applies-to ID"; Code[20])
        {
        ...
        field(87; "Retention Code"; Code[20])
        {
        ...
        field(88; "Retention  Amount"; Decimal)
        {
        }
        field(89; "Retention Rate"; Decimal)
        {
        }
        field(90; "W/Tax Rate"; Decimal)
        {
            TableRelation = "FIN-Tariff Codes".Percentage;
        }
        field(91; "Vendor Bank Account"; Code[20])
        {
        ...
        field(92; "EFT Bank Account No"; Code[20])
        {
        }
        field(93; "EFT Bank Code"; Code[20])
        {
        }
        field(94; "EFT Account Name"; Text[50])
        {
        }
        field(95; "EFT Branch No."; Code[20])
        {
        }
        ...
        field(98; "Document Line"; Code[20])
        {
        ...
        field(101; "PAYE Code"; Code[20])
        {
            TableRelation = "FIN-Tariff Codes".Code WHERE(Type = CONST(PAYE));
        }
        field(102; "Budgeted Amount"; Decimal)
        {
        ...
        field(103; "Actual Expenditure"; Decimal)
        {
            FieldClass = FlowField;
        ...
        field(104; "Committed Amount"; Decimal)
        {
            FieldClass = FlowField;
        ...
        field(105; "Budget Name"; Code[20])
        {
            TableRelation = "G/L Budget Name".Name;
        }
        field(106; "Budget Balance"; Decimal)
        {
            Editable = false;
        }
        field(107; "VAT Withheld Amount"; Decimal)
        {
        }
        field(108; "VAT Withheld Code"; Code[20])
        {
            TableRelation = "FIN-Tariff Codes".Code WHERE(Type = CONST(VAT));
        }
        field(109; "VAT Six % Rate"; Decimal)
        {
        }
        field(110; "Not Vatable"; Boolean)
        {
        }
        field(111; "Council No."; Code[20])
        {
        ...
        field(118; "Commision Amount"; Decimal)
        {
        ...
        field(119; "Advance Type"; Enum "Gen. Journal Account Type")
        {
        ...
        field(121; "Advance Name"; Text[150])
        {
        }
        field(122; "Advance Grouping"; Code[20])
        {
            TableRelation = "Customer Posting Group".Code;
        }
        field(123; "Advance Amount"; Decimal)
        {
            NotBlank = true;
            trigger OnValidate()
            begin
        ...
        field(124; "Applied Invoice"; Code[30])
        {

        }
        field(125; "Applied LPO"; Code[30])
        {

        }
        field(126; "Original Invoice"; Code[30])
        {
            FieldClass = FlowField;
            CalcFormula = lookup("Purch. Inv. Header"."No." where("No." = field("Applied Invoice")));
        }
        field(99; "Archived LPO"; Code[30])
        {
            FieldClass = FlowField;
            CalcFormula = lookup("Purch. Inv. Header"."No." where("No." = field("Applied LPO")));
        }
        field(127; "Invoice Posting Date"; Date)
        {

        }
        field(128; "Budgeted Acc"; Code[20])
        {
            FieldClass = FlowField;
            // CalcFormula = lookup("Purch. Inv. Line"."No." where("Document No." = field("Applies-to Doc. No.")));
            CalcFormula = lookup("G/L Entry"."G/L Account No." where("Document No." = field("Applies-to Doc. No.")));


        }
        field(129; "Budgeted Allocation"; Decimal)
        {
            // FieldClass = FlowField;
            // CalcFormula = Sum("G/L Budget Entry".Amount WHERE("G/L Account No." = FIELD("Account No."),
            //                                                     "Global Dimension 1 Code" = FIELD("Global Dimension 1 Code"),
        ...
        field(130; "Total Expense"; Decimal)
        {
            TableRelation = "FIN-Budget Entries".Amount;
            // TableRelation = "FIN-Budget Entries"."Credit Amount";
            CalcFormula = Sum("FIN-Budget Entries".Amount WHERE("Transaction Type" = FILTER(Expense),
                "Budget Name" = FIELD("Budget Name"), "G/L Account No." = FIELD("Account No.")));
            // "Global Dimension 1 Code" = field("Global Dimension 1 Code"),
            // "Global Dimension 2 Code" = field("Shortcut Dimension 2 Code")));
        ...
        field(132; "Total Commitment"; Decimal)
        {
            // Caption = 'Utilization';
            // TableRelation = "FIN-Budget Entries".Amount;
            //TableRelation = "FIN-Budget Entries"."Credit Amount";
        ...
        field(135; "Budgeted Allocation1"; Decimal)
        {
            // FieldClass = FlowField;
            // CalcFormula = Sum("G/L Budget Entry".Amount WHERE("G/L Account No." = FIELD("Budgeted Acc"),
            //                                                    // "Global Dimension 1 Code" = FIELD("Global Dimension 1 Code"),
            //                                                    // "Global Dimension 2 Code" = FIELD("Shortcut Dimension 2 Code"),
            //                                                    "Budget Name" = FIELD("Budget Name")));

        }
        field(136; "Total Expense1"; Decimal)
        {
            TableRelation = "FIN-Budget Entries".Amount;
            // TableRelation = "FIN-Budget Entries"."Credit Amount";
            CalcFormula = Sum("FIN-Budget Entries".Amount WHERE("Transaction Type" = FILTER(Expense),
                 "G/L Account No." = FIELD("Budgeted Acc"),
                 "Budget Name" = FIELD("Budget Name")));
            // "Global Dimension 1 Code" = field("Global Dimension 1 Code"),
            // "Global Dimension 2 Code" = field("Shortcut Dimension 2 Code")));
            //"Budget Dimension 3 Code" = field("Global Dimension 3 Code")));
        ...
        field(137; "Total Commitment1"; Decimal)
        {
            // Caption = 'Utilization';
            TableRelation = "FIN-Budget Entries".Amount;
            //TableRelation = "FIN-Budget Entries"."Credit Amount";
        ...
        field(131; "Budget Balance1"; Decimal)
        {
            Editable = false;
        }
        field(139; "Total Expense & Commitment"; Decimal)
        {


        }
        field(140; "Total Expense & Commitment1"; Decimal)
        {
            FieldClass = FlowField;
        ...
        field(50024; "Manual Tax"; Boolean)
        {

        }
        field(133; Amount2; Decimal)
        {
            //  TableRelation = "FIN-Payment Line".Amount;
            // trigger OnValidate()
            // var
            //     myInt: Integer;
            // begin
    ...
    begin
        ...
        // FinBudgetEntries.SetRange(FinBudgetEntries."G/L Account No.", No);
        // FinBudgetEntries.SetRange("Budget Name", "Budget Name");
        // if FinBudgetEntries.FindFirst() then begin
        //     "Budgeted Allocation" := FinBudgetEntries.Allocation;
        //     "Budgeted Allocation1" := FinBudgetEntries.Allocation;
        //     "Budget Balance" := FinBudgetEntries.Balance;
        //end;
        PHead.RESET;
        PHead.SETRANGE(PHead."No.", No);
        IF PHead.FINDFIRST THEN BEGIN
    ...
    var
        Tarrifcodes: Record "FIN-Tariff Codes";
        Payecode: Code[50];
    ...
    begin
        ...
        IF Amount <> 0 THEN BEGIN
            ...
            IF "PAYE Code" <> '' THEN BEGIN
                ...
                RecPayTypes.SETRANGE(RecPayTypes.Code, Type);
                IF RecPayTypes.FIND('-') THEN begin
                    Payecode := RecPayTypes."PAYE Tax Code";
                    Tarrifcodes.Reset();
                    Tarrifcodes.SetRange(Code, Payecode);
                    if Tarrifcodes.Find('-') then begin
                        "PAYE Amount" := (((Tarrifcodes.Percentage) / 100) * Amount);
                    end;
                end;
    ...
    procedure SetPVAllocationsBalance(GLAccountNo: Code[10]; Dim1: Code[10]; Dim2: code[10]; BudgetCode: code[10]): Decimal
    var
    ...
    begin
        ...
        BudgetEntries.SetFilter("Transaction Type", '%1', BudgetEntries."Transaction Type"::Allocation);
    ...
    //PV Budget Allocation Balance
    procedure SetBudgetAllocation(var PvHeader: Record "FIN-Payments Header")
    var
    ...
    begin
        ...
        if pvlines.FindSet() then
            repeat begin
                SetBudgetAllocation(pvlines);
            end until pvlines.Next() = 0;
        ;
    end;

    procedure SetBudgetAllocation(var PVLine: Record "FIN-Payment Line")
    var
        AccNo: Code[25];
    begin
        case
            PVLine."Account Type" of
            PVLine."Account Type"::"G/L Account":
                AccNo := PVLine."Account No.";
            PVLine."Account Type"::Vendor:
                begin
                    PVLine.CalcFields("Budgeted Acc");
                    if PVLine."Budgeted Acc" <> '' then
                        AccNo := PVLine."Budgeted Acc";
                end;
        end;
        if AccNo <> '' then begin
            PVLine."Budgeted Allocation" := SetPVAllocationsBalance(AccNo, PVLine."Global Dimension 1 Code", PVLine."Shortcut Dimension 2 Code", PVLine."Budget Name");

            PVLine.Modify();
        end;
    end;

    procedure SetAmount2(var PVLine: Record "FIN-Payment Line")
    begin
        if PVLine."Account Type" = PVLine."Account Type"::"G/L Account" then
            Amount2 := 0 else
            if PVLine."Account Type" = PVLine."Account Type"::Vendor then
                Amount2 := rec.Amount;
                if PVLine."Account Type" = PVLine."Account Type"::"G/L Account" then
            Amount3 := rec.Amount else
            if PVLine."Account Type" = PVLine."Account Type"::Vendor then
                Amount3 := 0;
    end;
