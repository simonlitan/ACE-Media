page 52178700 "FIN-Memo Header List All"
{
    ...
    actions
    {
        ...
        area(reporting)
        {
            action("Memo Bank Schedule")
            {
                ApplicationArea = all;
                Image = "Report";
                //  RunObject = Report 70283;
            }
            action("Memo Net Schedule")
            {
                ApplicationArea = all;
                Image = "Report";
                // RunObject = Report 70285;
            }
            action("MEmo-Tax Schedule")
            {
                ApplicationArea = all;
                Image = "Report";
                // RunObject = Report 70286;
            }
        }
    }
