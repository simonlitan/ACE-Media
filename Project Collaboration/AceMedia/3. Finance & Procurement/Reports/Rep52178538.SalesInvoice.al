/// <summary>
/// Report Sales Invoice (ID 52178505).
/// </summary>
report 52178538 "Sales Invoice"
{
    RDLCLayout = './Reports/SSR/SalesInvoice.rdl';
    WordLayout = './Reports/SSR/sales-invoice2.docx';
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            dataitem(Customer; Customer)
            {
                ...
                column(HSCode_Customer; "HS Code")
                {
                }
                column(KRApin_Customer; "KRA pin")
                {
                }
                column(VATRegistrationNo_Customer; "VAT Registration No.")
                {
                }
            }
            ...
            var
                ...
                O365SalesInvoiceMgmt: Codeunit "O365 Sales Management 2";
            begin
