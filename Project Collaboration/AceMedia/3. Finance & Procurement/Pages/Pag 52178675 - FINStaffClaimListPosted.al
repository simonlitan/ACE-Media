page 52178675 "FIN-Staff Claim List Posted"
{
        ...
        area(processing)
        {
            ...
            action(sendApproval)
            {
                ...
                begin
                    ...
                    if ApprovalMgt.IsClaimsEnabled(Rec) = true then
                        ApprovalMgt.OnSendClaimforApproval(Rec);
            ...
            action(cancellsApproval)
            {
                ...
                begin
                    CancelCommitment;
                    if ApprovalMgt.IsClaimsEnabled(Rec) = true then
                        ApprovalMgt.OnCancelClaimForApproval(Rec);
                end;
            }
            separator(_______)
            {
            ...
            action("Print/Preview")
            {
                ...
                begin
                    ...
                    Rec.RESET;
                    Rec.SETFILTER("No.", Rec."No.");
                    REPORT.RUN(52178708, TRUE, TRUE, Rec);
                    Rec.RESET;
                end;
            }
                ...
                IF FINBudgetEntries.FIND('-') THEN BEGIN
                    IF FINBudgetEntries.CALCSUMS(Amount) THEN BEGIN
                        IF FINBudgetEntries.Amount > 0 THEN BEGIN
                            ...
                            // Commit Budget Here
                            PostBudgetEnties.CheckBudgetAvailability(FINStaffClaimLines."Account No.", Rec.Date, Rec."Global Dimension 1 Code",
                             Rec."Shortcut Dimension 2 Code", FINStaffClaimLines.Amount,
                             FINStaffClaimLines."Account Name", 'CLAIM', Rec."No." + FINStaffClaimLines."Account No." + '-' + Format(FINStaffClaimLines."Line No."), Rec.Purpose);
                        END ELSE
        ...
        IF FINStaffClaimLines.FIND('-') THEN BEGIN
            ...
            BEGIN
                ...
                IF (FINStaffClaimLines.Amount > 0) THEN BEGIN
                  ...
                  FINStaffClaimLines.Amount, FINStaffClaimLines."Account Name", USERID, TODAY, 'CLAIM',
                    Rec."No." + FINStaffClaimLines."Account No." + '-' + Format(FINStaffClaimLines."Line No."), Rec.Purpose);
                END;
            END;
            UNTIL FINStaffClaimLines.NEXT = 0;
        END;
    ...
    begin
        ...
        IF FINStaffClaimLines.FIND('-') THEN BEGIN
            ...
            BEGIN
                ...
                IF (FINStaffClaimLines.Amount > 0) THEN BEGIN
                    // Commit Budget Here
                    PostBudgetEnties.CancelBudgetCommitment(FINStaffClaimLines."Account No.", Rec.Date, Rec."Global Dimension 1 Code",
                    Rec."Shortcut Dimension 2 Code", rec."Shortcut Dimension 3 Code", FINStaffClaimLines.Amount, FINStaffClaimLines."Account Name",
                    USERID, 'CLAIM', Rec."No." + FINStaffClaimLines."Account No." + '-' + Format(FINStaffClaimLines."Line No."), Rec.Purpose);
                END;
            END;
            UNTIL FINStaffClaimLines.NEXT = 0;
        END;
