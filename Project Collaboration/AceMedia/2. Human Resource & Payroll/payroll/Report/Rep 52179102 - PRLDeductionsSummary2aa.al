report 52179102 "PRL-Deductions Summary 2 aa"
{
    DefaultLayout = RDLC;
    RDLCLayout = './payroll/Report/SSR/PRL-Deductions Summary 2.rdl';
    ...
    dataset
    {
        dataitem("PRL-Period Transactions"; "PRL-Period Transactions")
        {
            ...
            column(EmpName2; emps."First Name" + ' ' + emps."Middle Name" + ' ' + emps."Last Name")
            {
            }
            column(empName; "PRL-Period Transactions"."Employee Name")
            {
            }
            ...
            begin
                Clear(empName);
                if "prPeriod Transactions"."Employee Code" <> '' then
               ...
               // Clear(empName);
                ...
                // if emps.Get("PRL-Period Transactions"."Employee Code") then begin
                //     empName := emps."First Name" + ' ' + emps."Middle Name" + ' ' + emps."Last Name";
                // end;
    ...
    var
        ...
        "prPeriod Transactions": record "PRL-Period Transactions";
