table 52179120 "HRM-Training Courses"
{
    ...
    fields
    {
        ...
        field(9; "Re-Assessment Date"; Date)
        {
        }
        field(10; "Need Source"; Option)
        {
        ...
        field(16; "Qualification Code"; Code[20])
        {
        ...
        field(17; "Qualification Type"; Code[30])
        {
            NotBlank = true;
            TableRelation = "HRM-Lookup Values".Code WHERE(Type = CONST("Qualification Type"));
        }
        field(18; "Qualification Description"; Text[80])
        {
        }
        field(19; "Training Applicants"; Integer)
        {
            CalcFormula = Count("HRM-Training Applications" WHERE("Course Title" = FIELD("Course Code")));
            FieldClass = FlowField;
        }
        field(20; "Training Applicants (Passed)"; Integer)
        {
            CalcFormula = Count("HRM-Training Applications" WHERE("Course Title" = FIELD("Course Code"),
                                                                   "Training Evaluation Results" = CONST(Passed)));
            FieldClass = FlowField;
        }
        field(21; "Training Applicants (Failed)"; Integer)
        {
            CalcFormula = Count("HRM-Training Applications" WHERE("Course Title" = FIELD("Course Code"),
                                                                   "Training Evaluation Results" = CONST(Failed)));
            FieldClass = FlowField;
        }
        field(22; "Provider Name"; Text[50])
        {
        }
        field(23; "No of Participants Required"; Integer)
        {
        }
        field(24; "Nature of Training"; Option)
        {
            OptionCaption = ' ,Internal,External,Self,E-Learning';
            OptionMembers = " ",Internal,External,Self,"E-Learning";
        }
        field(25; "Training Type"; Option)
        {
            OptionCaption = ',Long course,Short Course,Seminar,Workshop';
            OptionMembers = ,"Long course","Short Course",Seminar,Workshop;
        }
        field(26; "Course Version"; Code[20])
        {
        }
        field(27; "Course Version Description"; Text[200])
        {
        }
        field(28; "Individual Course"; Boolean)
        {
        }
        field(29; "Closing Status"; Option)
        {
        ...
        field(30; "Quarter Offered"; Option)
        {
            OptionCaption = ' 1st Quarter,2nd Quarter,3rd Quarter';
            OptionMembers = " 1st Quarter","2nd Quarter","3rd Quarter";
        }
        field(31; "Directorate Name"; Text[100])
        {
            Editable = false;
        }
        field(32; "Department Name"; Text[100])
        {
            Editable = false;
        }
        field(33; "Station Code"; Code[10])
        {
