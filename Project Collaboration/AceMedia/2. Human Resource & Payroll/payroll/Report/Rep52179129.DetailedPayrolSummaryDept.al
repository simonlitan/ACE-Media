report 52179129 "Detailed Payrol Summary/Dept"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("PRL-Period Transactions"; "PRL-Period Transactions")
        {
            ...
            column(DeptCodez; HRMEmployeeD."Global Dimension 2 Code")
            {
            }
            ...
            begin
               ...
               IF "PRL-Period Transactions".FINDFIRST THEN    BEGIN
                ...
                IF HRMEmployeeD.FIND('-') THEN BEGIN
                    ...
                    "Dimension Value".SETFILTER("Dimension Value".Code, HRMEmployeeD."Global Dimension 2 Code");
