table 52179362 "Strategic Objective"
{
    ...
    fields
    {
        ...
        field(16; "Strategies"; Code[10])
        {
            ...
            trigger OnValidate()
            var
                Strat: Record Strategies;
            begin
                if Strat.Get(Strategies) then
                    "Strategies Desc" := Strat.Description;
        ...
        field(11; KRA; Code[10])
        {
            ...
            var
                Kr: Record KRA;
            begin
                if Kr.Get(rec.KRA) then
                    "KRA Description" := Kr.Description;
            end;
