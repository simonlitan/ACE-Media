report 52179134 "PRL-Payslips V 1.1.1"
{
    DefaultLayout = RDLC;
        ...
        dataitem("PRL-Period Transactions"; "PRL-Period Transactions")
        {
            ...
            begin
                ...
                if objEmp.Find('-') then begin
                    Retirementdate := objEmp."Retirement date";
            ...
            trigger OnPreDataItem()
            begin
                "PRL-Period Transactions".SetFilter("PRL-Period Transactions"."Payroll Period", '=%1', PeriodFilter);
    ...
    begin
        ...
        PRLPayrollPeriods.Reset;
        PRLPayrollPeriods.SetRange("Date Opened", PeriodFilter);
