report 52179089 "Employee Details Summary"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(DataItem1000000001; "HRM-Employee C")
        {
            ...
            column(ShortcutDimension3Code_DataItem1000000001; "Shortcut Dimension 3 Code")
            {
            }
            ...
            dataitem("HRM-Job Responsiblities"; "HRM-Job Responsiblities (B)")
            {
                DataItemLink = "Job ID" = field("Job Id");

                column(ResponsibilityCode_HRMJobResponsiblities; "Responsibility Code")
                {
                }
                column(ResponsibilityDescription_HRMJobResponsiblities; "Responsibility Description")
                {
                }
            }
