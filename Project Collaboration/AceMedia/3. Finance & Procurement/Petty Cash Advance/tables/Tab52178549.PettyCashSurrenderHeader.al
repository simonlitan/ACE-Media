table 52178549 "PettyCash Surrender Header"
{
    ...
    fields
    {
        ...
        field(15; "Posting Description"; Text[250])
        {
        }
        field(16; "Paying Bank Account"; Code[20])
        {
        }
        ...
        field(29; "Shortcut Dimension 3"; code[80])
        {
            CaptionClass = '1,2,3';
        ...
        field(25; "Cash Receipt No"; Code[20])
        {
        ...
        field(14; "On Behalf Of"; Text[100])
        {
