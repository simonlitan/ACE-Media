table 52178623 "FIN-Memo Details"
{
    ...
    fields
    {
        ...
        {
            DataClassification = ToBeClassified;
            TableRelation = IF ("Payee Type" = CONST(Employees)) "HRM-Employee C" where(Status = const(Active))
            ELSE
            IF ("Payee Type" = CONST(Employees)) "HRM-Other Payees";
            ...
            begin
                ...
                IF "Payee Type" = "Payee Type"::Employees THEN BEGIN
                    HRMEmployeeC.RESET;
                    HRMEmployeeD.SETRANGE("No.", "Staff no.");
                    HRMEmployeeC.SETRANGE("No.", "Staff no.");
                    IF HRMEmployeeC.FIND('-') THEN
                        ImprestHeader.Reset();
                    ImprestHeader.SetRange("Account No.", rec."Staff no.");
                    ImprestHeader.SetRange("Surrender Status", ImprestHeader."Surrender Status"::" ");
                    ImprestHeader.Setfilter(Status, '<>%1', ImprestHeader.Status::Archive);

                    // IF ImprestHeader.COUNT > 0 THEN
                ...
                IF "Payee Type" = "Payee Type"::"Public Servants" THEN BEGIN
                    OtherPayee.RESET;
        ...
        {
            DataClassification = ToBeClassified;
            OptionCaption = ' ,Employees,Public Servants,Attaches/Interns';
            OptionMembers = " ",Employees,"Public Servants","Attaches/Interns";
        }
            ...
            begin
                ...
                if fmemoheader.Find('-') then begin
                    ...
                    if HRMEmployeeC.Find('-') then begin
                        "Payee Type" := "Payee Type"::Employees;
